import type { Root, SerialChart, Series } from "@amcharts/amcharts5";
 ...
 * @param props.timeIntervalInfoWasReset Indicates if the time interval information was reset
 */
...
/**
 * Disables the ghost label on the axis by setting forceHidden to true
 * See issue: #8586 for details
 * @param axis The axis
 */
export declare function disableAxisGhostLabel(axis: Axis<AxisRenderer>): void;
/**
 * Resets the chart's axes zoom level to display the chart in full extent.
 * @param chart The chart
 */
export declare function resetZoomToFullExtent(chart: SerialChart): void;
