import type { Graphics, Sprite, Template } from "@amcharts/amcharts5";
import type { State } from "@amcharts/amcharts5/.internal/core/util/States";
...
import type { FillElementsProps, LineElementsProps, MarkerElementsProps, UpdateSymbolProps } from "./interfaces";
import type { MappedFillSymbol, MappedLineSymbol, MappedMarkerSymbol } from "../symbols/interfaces";
export declare function setOutlineProperties(element: Graphics | Sprite | Template<Graphics>, outline: MappedLineSymbol): void;
/**
 ...
 */
export declare function setStateProperties(state: State<Graphics>, theme?: SelectionThemeProperties): void;
