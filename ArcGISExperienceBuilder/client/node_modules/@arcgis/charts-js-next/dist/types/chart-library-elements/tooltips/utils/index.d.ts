import type { Graphics, Template, Sprite, Series } from "@amcharts/amcharts5";
import { Tooltip } from "@amcharts/amcharts5";
import type { ColumnSeries, XYSeries } from "@amcharts/amcharts5/xy";
import { LineSeries } from "@amcharts/amcharts5/xy";
import type { RadarLineSeries } from "@amcharts/amcharts5/radar";
import type { WebChartAxis, WebChartDataItemValue, WebChartLineChartSeries, WebChartBarChartSeries, WebChartBoxPlotSeries, NumberFormatOptions, DateTimeFormatOptions, WebChartRadarChartSeries } from "@arcgis/charts-spec";
 ...
 * @param series The series on which to initialize the tooltip
 */
export declare function initializeSeriesTooltip(series: XYSeries): Tooltip;
/**
 ...
 * @param series the series parent of the element
 */
export declare function seriesTooltipHTMLCallback(element: Sprite | Tooltip, series: Series): string;
/**
