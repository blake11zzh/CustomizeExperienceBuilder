...
interface PreactArcgisAreaMeasurement2d extends Partial<Pick<ArcgisAreaMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisAreaMeasurement2dElement> {
...
interface PreactArcgisAreaMeasurement3d extends Partial<Pick<ArcgisAreaMeasurement3d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisAreaMeasurement3dElement> {
...
interface PreactArcgisAttachments extends Partial<Pick<ArcgisAttachments, 'autoDestroyDisabled' | 'capabilities' | 'displayType' | 'graphic' | 'hideAddButton' | 'hideAddSubmitButton' | 'hideCancelAddButton' | 'hideCancelUpdateButton' | 'hideDeleteButton' | 'hideErrorMessage' | 'hideProgressBar' | 'hideUpdateButton' | 'icon' | 'label' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisAttachmentsElement> {
...
interface PreactArcgisBasemapGallery extends Partial<Pick<ArcgisBasemapGallery, 'activeBasemap' | 'autoDestroyDisabled' | 'disabled' | 'headingLevel' | 'icon' | 'label' | 'position' | 'referenceElement' | 'source'>>, PreactJsx.HTMLAttributes<HTMLArcgisBasemapGalleryElement> {
...
interface PreactArcgisBasemapToggle extends Partial<Pick<ArcgisBasemapToggle, 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'nextBasemap' | 'position' | 'referenceElement' | 'showTitle'>>, PreactJsx.HTMLAttributes<HTMLArcgisBasemapToggleElement> {
...
interface PreactArcgisBookmarks extends Partial<Pick<ArcgisBookmarks, 'autoDestroyDisabled' | 'bookmarks' | 'defaultCreateOptions' | 'defaultEditOptions' | 'disabled' | 'dragEnabled' | 'filterPlaceholder' | 'filterText' | 'hideFlow' | 'hideThumbnail' | 'hideTime' | 'icon' | 'label' | 'position' | 'referenceElement' | 'showAddBookmarkButton' | 'showCloseButton' | 'showCollapseButton' | 'showEditBookmarkButton' | 'showFilter' | 'showHeading'>>, PreactJsx.HTMLAttributes<HTMLArcgisBookmarksElement> {
...
interface PreactArcgisBuildingExplorer extends Partial<Pick<ArcgisBuildingExplorer, 'autoDestroyDisabled' | 'headingLevel' | 'hideDisciplines' | 'hideLevels' | 'hidePhases' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisBuildingExplorerElement> {
...
interface PreactArcgisCatalogLayerList extends Partial<Pick<ArcgisCatalogLayerList, 'autoDestroyDisabled' | 'catalogLayer' | 'collapsed' | 'filterPlaceholder' | 'filterPredicate' | 'filterText' | 'headingLevel' | 'hideFlow' | 'hideStatusIndicators' | 'icon' | 'label' | 'listItemCreatedFunction' | 'minFilterItems' | 'position' | 'referenceElement' | 'selectedItems' | 'selectionMode' | 'showCloseButton' | 'showCollapseButton' | 'showErrors' | 'showFilter' | 'showHeading' | 'showTemporaryLayerIndicators' | 'visibilityAppearance'>>, PreactJsx.HTMLAttributes<HTMLArcgisCatalogLayerListElement> {
...
interface PreactArcgisCompass extends Partial<Pick<ArcgisCompass, 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisCompassElement> {
...
interface PreactArcgisCoordinateConversion extends Partial<Pick<ArcgisCoordinateConversion, 'autoDestroyDisabled' | 'conversions' | 'formats' | 'headingLevel' | 'hideCaptureButton' | 'hideEditButton' | 'hideExpandButton' | 'hideSettingsButton' | 'icon' | 'label' | 'locationSymbol' | 'mode' | 'multipleConversionsDisabled' | 'orientation' | 'position' | 'referenceElement' | 'storageDisabled' | 'storageType'>>, PreactJsx.HTMLAttributes<HTMLArcgisCoordinateConversionElement> {
...
interface PreactArcgisDaylight extends Partial<Pick<ArcgisDaylight, 'autoDestroyDisabled' | 'currentSeason' | 'dateOrSeason' | 'dayPlaying' | 'headingLevel' | 'hideDatePicker' | 'hideHeader' | 'hidePlayButtons' | 'hideShadowsToggle' | 'hideSunLightingToggle' | 'hideTimezone' | 'icon' | 'label' | 'playSpeedMultiplier' | 'position' | 'referenceElement' | 'timeSliderSteps' | 'yearPlaying'>>, PreactJsx.HTMLAttributes<HTMLArcgisDaylightElement> {
  onarcgisReady?: EventHandler<HTMLArcgisDaylightElement["arcgisReady"]>;
}

interface PreactArcgisDirectionalPad extends Partial<Pick<ArcgisDirectionalPad, 'autoDestroyDisabled' | 'disabled' | 'hideDirectionalButtons' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'showRotationResetButton' | 'showRotationSlider' | 'visualScale'>>, PreactJsx.HTMLAttributes<HTMLArcgisDirectionalPadElement> {
...
interface PreactArcgisDirections extends Partial<Pick<ArcgisDirections, 'apiKey' | 'autoDestroyDisabled' | 'headingLevel' | 'hideLayerDetails' | 'hideSaveAsButton' | 'hideSaveButton' | 'icon' | 'label' | 'layer' | 'maxStops' | 'position' | 'referenceElement' | 'routeLayerItemId' | 'searchProperties' | 'unit' | 'useDefaultRouteLayer'>>, PreactJsx.HTMLAttributes<HTMLArcgisDirectionsElement> {
...
interface PreactArcgisDirectlineMeasurement3d extends Partial<Pick<ArcgisDirectLineMeasurement3d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisDirectlineMeasurement3dElement> {
...
interface PreactArcgisDistanceMeasurement2d extends Partial<Pick<ArcgisDistanceMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisDistanceMeasurement2dElement> {
...
interface PreactArcgisElevationProfile extends Partial<Pick<ArcgisElevationProfile, 'autoDestroyDisabled' | 'hideChart' | 'hideClearButton' | 'hideLegend' | 'hideSelectButton' | 'hideSettingsButton' | 'hideSketchButton' | 'hideUniformChartScalingToggle' | 'hideUnitSelector' | 'highlightEnabled' | 'hoveredChartPosition' | 'icon' | 'input' | 'label' | 'position' | 'profiles' | 'referenceElement' | 'uniformChartScaling' | 'unit' | 'unitOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisElevationProfileElement> {
...
interface PreactArcgisExpand extends Partial<Pick<ArcgisExpand, 'autoCollapse' | 'autoDestroyDisabled' | 'closeOnEsc' | 'collapseIcon' | 'collapseTooltip' | 'expanded' | 'expandIcon' | 'expandTooltip' | 'focusTrapEnabled' | 'group' | 'icon' | 'iconNumber' | 'label' | 'mode' | 'placement' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisExpandElement> {
  onarcgisReady?: EventHandler<HTMLArcgisExpandElement["arcgisReady"]>;
}

interface PreactArcgisFeature extends Partial<Pick<ArcgisFeature, 'autoDestroyDisabled' | 'defaultPopupTemplateEnabled' | 'graphic' | 'headingLevel' | 'hideContentAttachments' | 'hideContentExpression' | 'hideContentFields' | 'hideContentMedia' | 'hideContentText' | 'hideLastEditInfo' | 'hideTitle' | 'icon' | 'label' | 'location' | 'map' | 'position' | 'referenceElement' | 'spatialReference'>>, PreactJsx.HTMLAttributes<HTMLArcgisFeatureElement> {
...
interface PreactArcgisFeatureForm extends Partial<Pick<ArcgisFeatureForm, 'autoDestroyDisabled' | 'feature' | 'formTemplate' | 'groupDisplay' | 'headingLevel' | 'icon' | 'label' | 'layer' | 'position' | 'referenceElement' | 'timeZone'>>, PreactJsx.HTMLAttributes<HTMLArcgisFeatureFormElement> {
...
interface PreactArcgisFeatureTable extends Partial<Pick<ArcgisFeatureTable, 'actionColumnConfig' | 'attachmentsEnabled' | 'attributeTableTemplate' | 'autoDestroyDisabled' | 'autoRefreshDisabled' | 'columnReorderingDisabled' | 'description' | 'editingEnabled' | 'filterBySelectionEnabled' | 'filterGeometry' | 'hiddenFields' | 'hideColumnDescriptions' | 'hideColumnMenuItemsSortAscending' | 'hideColumnMenuItemsSortDescending' | 'hideColumnMenus' | 'hideHeader' | 'hideMenu' | 'hideMenuItemsClearSelection' | 'hideMenuItemsDeleteSelection' | 'hideMenuItemsExportSelectionToCsv' | 'hideMenuItemsRefreshData' | 'hideMenuItemsSelectedRecordsShowAllToggle' | 'hideMenuItemsSelectedRecordsShowSelectedToggle' | 'hideMenuItemsToggleColumns' | 'hideMenuItemsZoomToSelection' | 'hideProgress' | 'hideSelectionColumn' | 'hideTooltips' | 'highlightDisabled' | 'highlightIds' | 'icon' | 'initialSize' | 'label' | 'layer' | 'layerItemId' | 'layers' | 'layerUrl' | 'maxSize' | 'menuConfig' | 'multipleSelectionDisabled' | 'multipleSortEnabled' | 'objectIds' | 'outFields' | 'pageIndex' | 'pageSize' | 'paginationEnabled' | 'position' | 'referenceElement' | 'relatedRecordsEnabled' | 'relatedTable' | 'relatedTables' | 'returnGeometryEnabled' | 'returnMEnabled' | 'returnZEnabled' | 'rowHighlightIds' | 'showLayerDropdown' | 'tableController' | 'tableDisabled' | 'tableParent' | 'tableTemplate' | 'timeExtent' | 'timeZone'>>, PreactJsx.HTMLAttributes<HTMLArcgisFeatureTableElement> {
...
interface PreactArcgisFeatureTemplates extends Partial<Pick<ArcgisFeatureTemplates, 'autoDestroyDisabled' | 'enableListScroll' | 'filterFunction' | 'filterText' | 'groupBy' | 'headingLevel' | 'hideFilter' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement' | 'selectionMode'>>, PreactJsx.HTMLAttributes<HTMLArcgisFeatureTemplatesElement> {
...
interface PreactArcgisFeatures extends Partial<Pick<ArcgisFeatures, 'actions' | 'autoDestroyDisabled' | 'collapsed' | 'content' | 'featureNavigationTop' | 'features' | 'featuresPerPage' | 'featuresTitle' | 'featureViewModelAbilities' | 'goToOverride' | 'headerActions' | 'headingLevel' | 'hideActionBar' | 'hideCloseButton' | 'hideFeatureMenuHeading' | 'hideFeatureNavigation' | 'hideFlow' | 'hideHeading' | 'hideSpinner' | 'icon' | 'includeDefaultActions' | 'initialDisplayMode' | 'label' | 'map' | 'position' | 'promises' | 'referenceElement' | 'selectedFeatureIndex' | 'showCollapseButton' | 'spatialReference' | 'timeZone'>>, PreactJsx.HTMLAttributes<HTMLArcgisFeaturesElement> {
...
interface PreactArcgisFloorFilter extends Partial<Pick<ArcgisFloorFilter, 'autoDestroyDisabled' | 'facility' | 'headingLevel' | 'icon' | 'label' | 'level' | 'longNames' | 'position' | 'referenceElement' | 'site'>>, PreactJsx.HTMLAttributes<HTMLArcgisFloorFilterElement> {
  onarcgisReady?: EventHandler<HTMLArcgisFloorFilterElement["arcgisReady"]>;
}

interface PreactArcgisFullscreen extends Partial<Pick<ArcgisFullscreen, 'autoDestroyDisabled' | 'element' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisFullscreenElement> {
...
interface PreactArcgisHistogram extends Partial<Pick<ArcgisHistogram, 'autoDestroyDisabled' | 'average' | 'barCreatedFunction' | 'bins' | 'dataLineCreatedFunction' | 'dataLines' | 'icon' | 'label' | 'labelFormatFunction' | 'layout' | 'max' | 'min' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisHistogramElement> {
...
interface PreactArcgisHistogramRangeSlider extends Partial<Pick<ArcgisHistogramRangeSlider, 'autoDestroyDisabled' | 'average' | 'barCreatedFunction' | 'bins' | 'dataLineCreatedFunction' | 'dataLines' | 'excludedBarColor' | 'icon' | 'includedBarColor' | 'label' | 'labelFormatFunction' | 'max' | 'min' | 'position' | 'precision' | 'rangeType' | 'referenceElement' | 'standardDeviation' | 'standardDeviationCount' | 'values'>>, PreactJsx.HTMLAttributes<HTMLArcgisHistogramRangeSliderElement> {
...
interface PreactArcgisHome extends Partial<Pick<ArcgisHome, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'viewpoint'>>, PreactJsx.HTMLAttributes<HTMLArcgisHomeElement> {
...
interface PreactArcgisLayerList extends Partial<Pick<ArcgisLayerList, 'autoDestroyDisabled' | 'catalogOptions' | 'collapsed' | 'dragEnabled' | 'filterPlaceholder' | 'filterPredicate' | 'filterText' | 'headingLevel' | 'hideCatalogLayerList' | 'hideFlow' | 'hideStatusIndicators' | 'icon' | 'knowledgeGraphOptions' | 'label' | 'listItemCreatedFunction' | 'minDragEnabledItems' | 'minFilterItems' | 'position' | 'referenceElement' | 'selectedItems' | 'selectionMode' | 'showCloseButton' | 'showCollapseButton' | 'showErrors' | 'showFilter' | 'showHeading' | 'showTemporaryLayerIndicators' | 'visibilityAppearance'>>, PreactJsx.HTMLAttributes<HTMLArcgisLayerListElement> {
...
interface PreactArcgisLegend extends Partial<Pick<ArcgisLegend, 'activeLayerInfos' | 'autoDestroyDisabled' | 'basemapLegendVisible' | 'headingLevel' | 'hideLayersNotInCurrentView' | 'icon' | 'label' | 'layerInfos' | 'legendStyle' | 'position' | 'referenceElement' | 'respectLayerDefinitionExpression' | 'respectLayerVisibilityDisabled'>>, PreactJsx.HTMLAttributes<HTMLArcgisLegendElement> {
...
interface PreactArcgisLineOfSight extends Partial<Pick<ArcgisLineOfSight, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisLineOfSightElement> {
...
interface PreactArcgisLinkChartLayoutSwitcher extends Partial<Pick<ArcgisLinkChartLayoutSwitcher, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'preventExtentUpdate' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisLinkChartLayoutSwitcherElement> {
...
interface PreactArcgisLocate extends Partial<Pick<ArcgisLocate, 'autoDestroyDisabled' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'popupDisabled' | 'position' | 'referenceElement' | 'scale'>>, PreactJsx.HTMLAttributes<HTMLArcgisLocateElement> {
...
interface PreactArcgisMap extends Partial<Pick<ArcgisMap, 'autoDestroyDisabled' | 'background' | 'basemap' | 'basemapView' | 'constraints' | 'displayFilterDisabled' | 'extent' | 'fatalError' | 'floors' | 'graphics' | 'ground' | 'highlightOptions' | 'highlights' | 'ipsInfo' | 'itemId' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'resizeAlign' | 'rotation' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'timeZone' | 'viewpoint' | 'zoom'>>, ArcgisMapSetterTypes, PreactJsx.HTMLAttributes<HTMLArcgisMapElement> {
...
interface PreactArcgisMeasurement extends Partial<Pick<ArcgisMeasurement, 'activeTool' | 'areaUnit' | 'autoDestroyDisabled' | 'icon' | 'label' | 'linearUnit' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisMeasurementElement> {
...
interface PreactArcgisNavigationToggle extends Partial<Pick<ArcgisNavigationToggle, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'navigationMode' | 'position' | 'referenceElement' | 'state'>>, PreactJsx.HTMLAttributes<HTMLArcgisNavigationToggleElement> {
...
interface PreactArcgisPlacement extends Partial<Pick<ArcgisPlacement, 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisPlacementElement> {
  onarcgisReady?: EventHandler<HTMLArcgisPlacementElement["arcgisReady"]>;
}

interface PreactArcgisPrint extends Partial<Pick<ArcgisPrint, 'allowedFormats' | 'allowedLayouts' | 'autoDestroyDisabled' | 'exportedLinks' | 'extraParameters' | 'headingLevel' | 'icon' | 'includeDefaultTemplatesDisabled' | 'label' | 'portal' | 'position' | 'printServiceUrl' | 'referenceElement' | 'showPrintAreaEnabled' | 'templateCustomTextElements' | 'templateOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisPrintElement> {
...
interface PreactArcgisScaleBar extends Partial<Pick<ArcgisScaleBar, 'autoDestroyDisabled' | 'barStyle' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'unit'>>, PreactJsx.HTMLAttributes<HTMLArcgisScaleBarElement> {
  onarcgisReady?: EventHandler<HTMLArcgisScaleBarElement["arcgisReady"]>;
}

interface PreactArcgisScaleRangeSlider extends Partial<Pick<ArcgisScaleRangeSlider, 'autoDestroyDisabled' | 'disabled' | 'hidePreview' | 'hideScaleMenusMaxScaleMenu' | 'hideScaleMenusMinScaleMenu' | 'icon' | 'label' | 'layer' | 'maxScale' | 'maxScaleLimit' | 'minScale' | 'minScaleLimit' | 'mode' | 'position' | 'referenceElement' | 'region'>>, PreactJsx.HTMLAttributes<HTMLArcgisScaleRangeSliderElement> {
...
interface PreactArcgisScene extends Partial<Pick<ArcgisScene, 'alphaCompositingEnabled' | 'analyses' | 'autoDestroyDisabled' | 'basemap' | 'basemapView' | 'camera' | 'cameraFov' | 'cameraHeading' | 'cameraPosition' | 'cameraTilt' | 'clippingArea' | 'constraints' | 'displayFilterDisabled' | 'environment' | 'extent' | 'fatalError' | 'floors' | 'graphics' | 'ground' | 'highlightOptions' | 'highlights' | 'itemId' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'qualityProfile' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'viewingMode' | 'viewpoint' | 'zoom'>>, ArcgisSceneSetterTypes, PreactJsx.HTMLAttributes<HTMLArcgisSceneElement> {
...
interface PreactArcgisShadowCast extends Partial<Pick<ArcgisShadowCast, 'autoDestroyDisabled' | 'discreteOptions' | 'durationOptions' | 'endTimeOfDay' | 'headingLevel' | 'hideColorPicker' | 'hideDatePicker' | 'hideTimeRangeSlider' | 'hideTimezone' | 'hideTooltip' | 'hideVisualizationOptions' | 'icon' | 'label' | 'position' | 'referenceElement' | 'startTimeOfDay' | 'thresholdOptions' | 'utcOffset' | 'visualizationType'>>, PreactJsx.HTMLAttributes<HTMLArcgisShadowCastElement> {
...
interface PreactArcgisSlice extends Partial<Pick<ArcgisSlice, 'autoDestroyDisabled' | 'excludedLayers' | 'excludeGroundSurface' | 'headingLevel' | 'icon' | 'label' | 'position' | 'referenceElement' | 'shape' | 'tiltEnabled'>>, PreactJsx.HTMLAttributes<HTMLArcgisSliceElement> {
...
interface PreactArcgisSlider extends Partial<Pick<ArcgisSlider, 'autoDestroyDisabled' | 'draggableSegmentsEnabled' | 'effectiveMax' | 'effectiveMin' | 'icon' | 'label' | 'labelInputsEnabled' | 'layout' | 'max' | 'min' | 'position' | 'precision' | 'rangeLabelInputsEnabled' | 'referenceElement' | 'snapOnClickEnabled' | 'steps' | 'syncedSegmentsEnabled' | 'thumbsConstrained' | 'tickConfigs' | 'values'>>, PreactJsx.HTMLAttributes<HTMLArcgisSliderElement> {
...
interface PreactArcgisSwipe extends Partial<Pick<ArcgisSwipe, 'autoDestroyDisabled' | 'direction' | 'disabled' | 'hideDivider' | 'hideHandle' | 'icon' | 'label' | 'leadingLayers' | 'messageOverrides' | 'position' | 'referenceElement' | 'swipePosition' | 'trailingLayers'>>, PreactJsx.HTMLAttributes<HTMLArcgisSwipeElement> {
...
interface PreactArcgisTableList extends Partial<Pick<ArcgisTableList, 'autoDestroyDisabled' | 'collapsed' | 'dragEnabled' | 'filterPlaceholder' | 'filterPredicate' | 'filterText' | 'hideFlow' | 'hideStatusIndicators' | 'icon' | 'label' | 'listItemCreatedFunction' | 'minDragEnabledItems' | 'minFilterItems' | 'position' | 'referenceElement' | 'selectedItems' | 'selectionMode' | 'showCloseButton' | 'showCollapseButton' | 'showErrors' | 'showFilter' | 'showHeading' | 'showTemporaryTableIndicators'>>, PreactJsx.HTMLAttributes<HTMLArcgisTableListElement> {
...
interface PreactArcgisTimeSlider extends Partial<Pick<ArcgisTimeSlider, 'actions' | 'autoDestroyDisabled' | 'disabled' | 'fullTimeExtent' | 'icon' | 'label' | 'layout' | 'loop' | 'mode' | 'playRate' | 'position' | 'referenceElement' | 'stops' | 'tickConfigs' | 'timeExtent' | 'timeVisible' | 'timeZone'>>, PreactJsx.HTMLAttributes<HTMLArcgisTimeSliderElement> {
...
interface PreactArcgisTrack extends Partial<Pick<ArcgisTrack, 'autoDestroyDisabled' | 'error' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'positionFilterFunction' | 'referenceElement' | 'scale'>>, PreactJsx.HTMLAttributes<HTMLArcgisTrackElement> {
...
interface PreactArcgisUtilityNetworkValidateTopology extends Partial<Pick<ArcgisUtilityNetworkValidateTopology, 'extentToValidate' | 'position' | 'referenceElement' | 'utilityNetwork'>>, PreactJsx.HTMLAttributes<HTMLArcgisUtilityNetworkValidateTopologyElement> {
  onarcgisReady?: EventHandler<HTMLArcgisUtilityNetworkValidateTopologyElement["arcgisReady"]>;
}

interface PreactArcgisValuePicker extends Partial<Pick<ArcgisValuePicker, 'autoDestroyDisabled' | 'canNext' | 'canPlay' | 'canPrevious' | 'caption' | 'component' | 'hideNextButton' | 'hidePlayButton' | 'hidePreviousButton' | 'icon' | 'label' | 'layout' | 'loop' | 'playRate' | 'position' | 'referenceElement' | 'values'>>, PreactJsx.HTMLAttributes<HTMLArcgisValuePickerElement> {
...
interface PreactArcgisVersionManagement extends Partial<Pick<ArcgisVersionManagement, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'initialVersionInfos' | 'label' | 'messageOverrides' | 'mode' | 'pageSize' | 'position' | 'referenceElement' | 'versioningStates' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisVersionManagementElement> {
...
interface PreactArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisWeatherElement> {
...
interface PreactArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisZoomElement> {
...
declare module 'preact' {
  namespace createElement.JSX {
    interface IntrinsicElements extends PreactJsx.IntrinsicElements {
      "arcgis-area-measurement-2d": PreactArcgisAreaMeasurement2d;
      "arcgis-area-measurement-3d": PreactArcgisAreaMeasurement3d;
      ...
      "arcgis-daylight": PreactArcgisDaylight;
      "arcgis-directional-pad": PreactArcgisDirectionalPad;
      "arcgis-directions": PreactArcgisDirections;
      "arcgis-directline-measurement-3d": PreactArcgisDirectlineMeasurement3d;
      "arcgis-distance-measurement-2d": PreactArcgisDistanceMeasurement2d;
      "arcgis-editor": PreactArcgisEditor;
      "arcgis-elevation-profile": PreactArcgisElevationProfile;
      "arcgis-expand": PreactArcgisExpand;
      "arcgis-feature": PreactArcgisFeature;
      ...
      "arcgis-floor-filter": PreactArcgisFloorFilter;
      "arcgis-fullscreen": PreactArcgisFullscreen;
      "arcgis-histogram": PreactArcgisHistogram;
      "arcgis-histogram-range-slider": PreactArcgisHistogramRangeSlider;
      "arcgis-home": PreactArcgisHome;
      "arcgis-layer-list": PreactArcgisLayerList;
      "arcgis-legend": PreactArcgisLegend;
      "arcgis-line-of-sight": PreactArcgisLineOfSight;
      "arcgis-link-chart": PreactArcgisLinkChart;
      "arcgis-link-chart-layout-switcher": PreactArcgisLinkChartLayoutSwitcher;
      "arcgis-locate": PreactArcgisLocate;
      "arcgis-map": PreactArcgisMap;
      "arcgis-measurement": PreactArcgisMeasurement;
      "arcgis-navigation-toggle": PreactArcgisNavigationToggle;
      "arcgis-oriented-imagery-viewer": PreactArcgisOrientedImageryViewer;
      "arcgis-placement": PreactArcgisPlacement;
      "arcgis-print": PreactArcgisPrint;
      "arcgis-scale-bar": PreactArcgisScaleBar;
      "arcgis-scale-range-slider": PreactArcgisScaleRangeSlider;
      ...
      "arcgis-slice": PreactArcgisSlice;
      ...
      "arcgis-utility-network-associations": PreactArcgisUtilityNetworkAssociations;
      "arcgis-utility-network-trace": PreactArcgisUtilityNetworkTrace;
      "arcgis-utility-network-validate-topology": PreactArcgisUtilityNetworkValidateTopology;
      "arcgis-value-picker": PreactArcgisValuePicker;
      "arcgis-version-management": PreactArcgisVersionManagement;
      "arcgis-weather": PreactArcgisWeather;
      "arcgis-zoom": PreactArcgisZoom;
    }
  }
  namespace h.JSX {
    interface IntrinsicElements extends PreactJsx.IntrinsicElements {
