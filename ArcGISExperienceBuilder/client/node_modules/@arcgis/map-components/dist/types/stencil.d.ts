...
interface StencilArcgisAreaMeasurement2d extends Partial<Pick<ArcgisAreaMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisAreaMeasurement2dElement> {
...
interface StencilArcgisAreaMeasurement3d extends Partial<Pick<ArcgisAreaMeasurement3d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisAreaMeasurement3dElement> {
...
interface StencilArcgisAttachments extends Partial<Pick<ArcgisAttachments, 'autoDestroyDisabled' | 'capabilities' | 'displayType' | 'graphic' | 'hideAddButton' | 'hideAddSubmitButton' | 'hideCancelAddButton' | 'hideCancelUpdateButton' | 'hideDeleteButton' | 'hideErrorMessage' | 'hideProgressBar' | 'hideUpdateButton' | 'icon' | 'label' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisAttachmentsElement> {
...
interface StencilArcgisBasemapGallery extends Partial<Pick<ArcgisBasemapGallery, 'activeBasemap' | 'autoDestroyDisabled' | 'disabled' | 'headingLevel' | 'icon' | 'label' | 'position' | 'referenceElement' | 'source'>>, StencilJsx.HTMLAttributes<HTMLArcgisBasemapGalleryElement> {
...
interface StencilArcgisBasemapToggle extends Partial<Pick<ArcgisBasemapToggle, 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'nextBasemap' | 'position' | 'referenceElement' | 'showTitle'>>, StencilJsx.HTMLAttributes<HTMLArcgisBasemapToggleElement> {
...
interface StencilArcgisBookmarks extends Partial<Pick<ArcgisBookmarks, 'autoDestroyDisabled' | 'bookmarks' | 'defaultCreateOptions' | 'defaultEditOptions' | 'disabled' | 'dragEnabled' | 'filterPlaceholder' | 'filterText' | 'hideFlow' | 'hideThumbnail' | 'hideTime' | 'icon' | 'label' | 'position' | 'referenceElement' | 'showAddBookmarkButton' | 'showCloseButton' | 'showCollapseButton' | 'showEditBookmarkButton' | 'showFilter' | 'showHeading'>>, StencilJsx.HTMLAttributes<HTMLArcgisBookmarksElement> {
...
interface StencilArcgisBuildingExplorer extends Partial<Pick<ArcgisBuildingExplorer, 'autoDestroyDisabled' | 'headingLevel' | 'hideDisciplines' | 'hideLevels' | 'hidePhases' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisBuildingExplorerElement> {
...
interface StencilArcgisCompass extends Partial<Pick<ArcgisCompass, 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisCompassElement> {
...
interface StencilArcgisCoordinateConversion extends Partial<Pick<ArcgisCoordinateConversion, 'autoDestroyDisabled' | 'conversions' | 'formats' | 'headingLevel' | 'hideCaptureButton' | 'hideEditButton' | 'hideExpandButton' | 'hideSettingsButton' | 'icon' | 'label' | 'locationSymbol' | 'mode' | 'multipleConversionsDisabled' | 'orientation' | 'position' | 'referenceElement' | 'storageDisabled' | 'storageType'>>, StencilJsx.HTMLAttributes<HTMLArcgisCoordinateConversionElement> {
...
interface StencilArcgisDaylight extends Partial<Pick<ArcgisDaylight, 'autoDestroyDisabled' | 'currentSeason' | 'dateOrSeason' | 'dayPlaying' | 'headingLevel' | 'hideDatePicker' | 'hideHeader' | 'hidePlayButtons' | 'hideShadowsToggle' | 'hideSunLightingToggle' | 'hideTimezone' | 'icon' | 'label' | 'playSpeedMultiplier' | 'position' | 'referenceElement' | 'timeSliderSteps' | 'yearPlaying'>>, StencilJsx.HTMLAttributes<HTMLArcgisDaylightElement> {
  onArcgisReady?: EventHandler<HTMLArcgisDaylightElement["arcgisReady"]>;
}

interface StencilArcgisDirectionalPad extends Partial<Pick<ArcgisDirectionalPad, 'autoDestroyDisabled' | 'disabled' | 'hideDirectionalButtons' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'showRotationResetButton' | 'showRotationSlider' | 'visualScale'>>, StencilJsx.HTMLAttributes<HTMLArcgisDirectionalPadElement> {
...
interface StencilArcgisDirections extends Partial<Pick<ArcgisDirections, 'apiKey' | 'autoDestroyDisabled' | 'headingLevel' | 'hideLayerDetails' | 'hideSaveAsButton' | 'hideSaveButton' | 'icon' | 'label' | 'layer' | 'maxStops' | 'position' | 'referenceElement' | 'routeLayerItemId' | 'searchProperties' | 'unit' | 'useDefaultRouteLayer'>>, StencilJsx.HTMLAttributes<HTMLArcgisDirectionsElement> {
...
interface StencilArcgisDirectlineMeasurement3d extends Partial<Pick<ArcgisDirectLineMeasurement3d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisDirectlineMeasurement3dElement> {
...
interface StencilArcgisDistanceMeasurement2d extends Partial<Pick<ArcgisDistanceMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisDistanceMeasurement2dElement> {
...
interface StencilArcgisElevationProfile extends Partial<Pick<ArcgisElevationProfile, 'autoDestroyDisabled' | 'hideChart' | 'hideClearButton' | 'hideLegend' | 'hideSelectButton' | 'hideSettingsButton' | 'hideSketchButton' | 'hideUniformChartScalingToggle' | 'hideUnitSelector' | 'highlightEnabled' | 'hoveredChartPosition' | 'icon' | 'input' | 'label' | 'position' | 'profiles' | 'referenceElement' | 'uniformChartScaling' | 'unit' | 'unitOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisElevationProfileElement> {
...
interface StencilArcgisFeatureForm extends Partial<Pick<ArcgisFeatureForm, 'autoDestroyDisabled' | 'feature' | 'formTemplate' | 'groupDisplay' | 'headingLevel' | 'icon' | 'label' | 'layer' | 'position' | 'referenceElement' | 'timeZone'>>, StencilJsx.HTMLAttributes<HTMLArcgisFeatureFormElement> {
...
interface StencilArcgisFeatureTable extends Partial<Pick<ArcgisFeatureTable, 'actionColumnConfig' | 'attachmentsEnabled' | 'attributeTableTemplate' | 'autoDestroyDisabled' | 'autoRefreshDisabled' | 'columnReorderingDisabled' | 'description' | 'editingEnabled' | 'filterBySelectionEnabled' | 'filterGeometry' | 'hiddenFields' | 'hideColumnDescriptions' | 'hideColumnMenuItemsSortAscending' | 'hideColumnMenuItemsSortDescending' | 'hideColumnMenus' | 'hideHeader' | 'hideMenu' | 'hideMenuItemsClearSelection' | 'hideMenuItemsDeleteSelection' | 'hideMenuItemsExportSelectionToCsv' | 'hideMenuItemsRefreshData' | 'hideMenuItemsSelectedRecordsShowAllToggle' | 'hideMenuItemsSelectedRecordsShowSelectedToggle' | 'hideMenuItemsToggleColumns' | 'hideMenuItemsZoomToSelection' | 'hideProgress' | 'hideSelectionColumn' | 'hideTooltips' | 'highlightDisabled' | 'highlightIds' | 'icon' | 'initialSize' | 'label' | 'layer' | 'layerItemId' | 'layers' | 'layerUrl' | 'maxSize' | 'menuConfig' | 'multipleSelectionDisabled' | 'multipleSortEnabled' | 'objectIds' | 'outFields' | 'pageIndex' | 'pageSize' | 'paginationEnabled' | 'position' | 'referenceElement' | 'relatedRecordsEnabled' | 'relatedTable' | 'relatedTables' | 'returnGeometryEnabled' | 'returnMEnabled' | 'returnZEnabled' | 'rowHighlightIds' | 'showLayerDropdown' | 'tableController' | 'tableDisabled' | 'tableParent' | 'tableTemplate' | 'timeExtent' | 'timeZone'>>, StencilJsx.HTMLAttributes<HTMLArcgisFeatureTableElement> {
...
interface StencilArcgisFeatureTemplates extends Partial<Pick<ArcgisFeatureTemplates, 'autoDestroyDisabled' | 'enableListScroll' | 'filterFunction' | 'filterText' | 'groupBy' | 'headingLevel' | 'hideFilter' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement' | 'selectionMode'>>, StencilJsx.HTMLAttributes<HTMLArcgisFeatureTemplatesElement> {
...
interface StencilArcgisFeatures extends Partial<Pick<ArcgisFeatures, 'actions' | 'autoDestroyDisabled' | 'collapsed' | 'content' | 'featureNavigationTop' | 'features' | 'featuresPerPage' | 'featuresTitle' | 'featureViewModelAbilities' | 'goToOverride' | 'headerActions' | 'headingLevel' | 'hideActionBar' | 'hideCloseButton' | 'hideFeatureMenuHeading' | 'hideFeatureNavigation' | 'hideFlow' | 'hideHeading' | 'hideSpinner' | 'icon' | 'includeDefaultActions' | 'initialDisplayMode' | 'label' | 'map' | 'position' | 'promises' | 'referenceElement' | 'selectedFeatureIndex' | 'showCollapseButton' | 'spatialReference' | 'timeZone'>>, StencilJsx.HTMLAttributes<HTMLArcgisFeaturesElement> {
...
interface StencilArcgisFloorFilter extends Partial<Pick<ArcgisFloorFilter, 'autoDestroyDisabled' | 'facility' | 'headingLevel' | 'icon' | 'label' | 'level' | 'longNames' | 'position' | 'referenceElement' | 'site'>>, StencilJsx.HTMLAttributes<HTMLArcgisFloorFilterElement> {
  onArcgisReady?: EventHandler<HTMLArcgisFloorFilterElement["arcgisReady"]>;
}

interface StencilArcgisFullscreen extends Partial<Pick<ArcgisFullscreen, 'autoDestroyDisabled' | 'element' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisFullscreenElement> {
...
interface StencilArcgisHistogram extends Partial<Pick<ArcgisHistogram, 'autoDestroyDisabled' | 'average' | 'barCreatedFunction' | 'bins' | 'dataLineCreatedFunction' | 'dataLines' | 'icon' | 'label' | 'labelFormatFunction' | 'layout' | 'max' | 'min' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisHistogramElement> {
...
interface StencilArcgisHistogramRangeSlider extends Partial<Pick<ArcgisHistogramRangeSlider, 'autoDestroyDisabled' | 'average' | 'barCreatedFunction' | 'bins' | 'dataLineCreatedFunction' | 'dataLines' | 'excludedBarColor' | 'icon' | 'includedBarColor' | 'label' | 'labelFormatFunction' | 'max' | 'min' | 'position' | 'precision' | 'rangeType' | 'referenceElement' | 'standardDeviation' | 'standardDeviationCount' | 'values'>>, StencilJsx.HTMLAttributes<HTMLArcgisHistogramRangeSliderElement> {
...
interface StencilArcgisHome extends Partial<Pick<ArcgisHome, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'viewpoint'>>, StencilJsx.HTMLAttributes<HTMLArcgisHomeElement> {
...
interface StencilArcgisLayerList extends Partial<Pick<ArcgisLayerList, 'autoDestroyDisabled' | 'catalogOptions' | 'collapsed' | 'dragEnabled' | 'filterPlaceholder' | 'filterPredicate' | 'filterText' | 'headingLevel' | 'hideCatalogLayerList' | 'hideFlow' | 'hideStatusIndicators' | 'icon' | 'knowledgeGraphOptions' | 'label' | 'listItemCreatedFunction' | 'minDragEnabledItems' | 'minFilterItems' | 'position' | 'referenceElement' | 'selectedItems' | 'selectionMode' | 'showCloseButton' | 'showCollapseButton' | 'showErrors' | 'showFilter' | 'showHeading' | 'showTemporaryLayerIndicators' | 'visibilityAppearance'>>, StencilJsx.HTMLAttributes<HTMLArcgisLayerListElement> {
...
interface StencilArcgisLegend extends Partial<Pick<ArcgisLegend, 'activeLayerInfos' | 'autoDestroyDisabled' | 'basemapLegendVisible' | 'headingLevel' | 'hideLayersNotInCurrentView' | 'icon' | 'label' | 'layerInfos' | 'legendStyle' | 'position' | 'referenceElement' | 'respectLayerDefinitionExpression' | 'respectLayerVisibilityDisabled'>>, StencilJsx.HTMLAttributes<HTMLArcgisLegendElement> {
...
interface StencilArcgisLineOfSight extends Partial<Pick<ArcgisLineOfSight, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisLineOfSightElement> {
...
interface StencilArcgisLinkChartLayoutSwitcher extends Partial<Pick<ArcgisLinkChartLayoutSwitcher, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'preventExtentUpdate' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisLinkChartLayoutSwitcherElement> {
...
interface StencilArcgisLocate extends Partial<Pick<ArcgisLocate, 'autoDestroyDisabled' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'popupDisabled' | 'position' | 'referenceElement' | 'scale'>>, StencilJsx.HTMLAttributes<HTMLArcgisLocateElement> {
...
interface StencilArcgisMap extends Partial<Pick<ArcgisMap, 'autoDestroyDisabled' | 'background' | 'basemap' | 'basemapView' | 'constraints' | 'displayFilterDisabled' | 'extent' | 'fatalError' | 'floors' | 'graphics' | 'ground' | 'highlightOptions' | 'highlights' | 'ipsInfo' | 'itemId' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'resizeAlign' | 'rotation' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'timeZone' | 'viewpoint' | 'zoom'>>, ArcgisMapSetterTypes, StencilJsx.HTMLAttributes<HTMLArcgisMapElement> {
...
interface StencilArcgisMeasurement extends Partial<Pick<ArcgisMeasurement, 'activeTool' | 'areaUnit' | 'autoDestroyDisabled' | 'icon' | 'label' | 'linearUnit' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisMeasurementElement> {
...
interface StencilArcgisNavigationToggle extends Partial<Pick<ArcgisNavigationToggle, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'navigationMode' | 'position' | 'referenceElement' | 'state'>>, StencilJsx.HTMLAttributes<HTMLArcgisNavigationToggleElement> {
...
interface StencilArcgisPlacement extends Partial<Pick<ArcgisPlacement, 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisPlacementElement> {
  onArcgisReady?: EventHandler<HTMLArcgisPlacementElement["arcgisReady"]>;
}

interface StencilArcgisPrint extends Partial<Pick<ArcgisPrint, 'allowedFormats' | 'allowedLayouts' | 'autoDestroyDisabled' | 'exportedLinks' | 'extraParameters' | 'headingLevel' | 'icon' | 'includeDefaultTemplatesDisabled' | 'label' | 'portal' | 'position' | 'printServiceUrl' | 'referenceElement' | 'showPrintAreaEnabled' | 'templateCustomTextElements' | 'templateOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisPrintElement> {
...
interface StencilArcgisScaleBar extends Partial<Pick<ArcgisScaleBar, 'autoDestroyDisabled' | 'barStyle' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'unit'>>, StencilJsx.HTMLAttributes<HTMLArcgisScaleBarElement> {
  onArcgisReady?: EventHandler<HTMLArcgisScaleBarElement["arcgisReady"]>;
}

interface StencilArcgisScaleRangeSlider extends Partial<Pick<ArcgisScaleRangeSlider, 'autoDestroyDisabled' | 'disabled' | 'hidePreview' | 'hideScaleMenusMaxScaleMenu' | 'hideScaleMenusMinScaleMenu' | 'icon' | 'label' | 'layer' | 'maxScale' | 'maxScaleLimit' | 'minScale' | 'minScaleLimit' | 'mode' | 'position' | 'referenceElement' | 'region'>>, StencilJsx.HTMLAttributes<HTMLArcgisScaleRangeSliderElement> {
...
interface StencilArcgisScene extends Partial<Pick<ArcgisScene, 'alphaCompositingEnabled' | 'analyses' | 'autoDestroyDisabled' | 'basemap' | 'basemapView' | 'camera' | 'cameraFov' | 'cameraHeading' | 'cameraPosition' | 'cameraTilt' | 'clippingArea' | 'constraints' | 'displayFilterDisabled' | 'environment' | 'extent' | 'fatalError' | 'floors' | 'graphics' | 'ground' | 'highlightOptions' | 'highlights' | 'itemId' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'qualityProfile' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'viewingMode' | 'viewpoint' | 'zoom'>>, ArcgisSceneSetterTypes, StencilJsx.HTMLAttributes<HTMLArcgisSceneElement> {
...
interface StencilArcgisSlice extends Partial<Pick<ArcgisSlice, 'autoDestroyDisabled' | 'excludedLayers' | 'excludeGroundSurface' | 'headingLevel' | 'icon' | 'label' | 'position' | 'referenceElement' | 'shape' | 'tiltEnabled'>>, StencilJsx.HTMLAttributes<HTMLArcgisSliceElement> {
...
interface StencilArcgisSwipe extends Partial<Pick<ArcgisSwipe, 'autoDestroyDisabled' | 'direction' | 'disabled' | 'hideDivider' | 'hideHandle' | 'icon' | 'label' | 'leadingLayers' | 'messageOverrides' | 'position' | 'referenceElement' | 'swipePosition' | 'trailingLayers'>>, StencilJsx.HTMLAttributes<HTMLArcgisSwipeElement> {
...
interface StencilArcgisTimeSlider extends Partial<Pick<ArcgisTimeSlider, 'actions' | 'autoDestroyDisabled' | 'disabled' | 'fullTimeExtent' | 'icon' | 'label' | 'layout' | 'loop' | 'mode' | 'playRate' | 'position' | 'referenceElement' | 'stops' | 'tickConfigs' | 'timeExtent' | 'timeVisible' | 'timeZone'>>, StencilJsx.HTMLAttributes<HTMLArcgisTimeSliderElement> {
...
interface StencilArcgisTrack extends Partial<Pick<ArcgisTrack, 'autoDestroyDisabled' | 'error' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'positionFilterFunction' | 'referenceElement' | 'scale'>>, StencilJsx.HTMLAttributes<HTMLArcgisTrackElement> {
...
interface StencilArcgisUtilityNetworkValidateTopology extends Partial<Pick<ArcgisUtilityNetworkValidateTopology, 'extentToValidate' | 'position' | 'referenceElement' | 'utilityNetwork'>>, StencilJsx.HTMLAttributes<HTMLArcgisUtilityNetworkValidateTopologyElement> {
  onArcgisReady?: EventHandler<HTMLArcgisUtilityNetworkValidateTopologyElement["arcgisReady"]>;
}

interface StencilArcgisValuePicker extends Partial<Pick<ArcgisValuePicker, 'autoDestroyDisabled' | 'canNext' | 'canPlay' | 'canPrevious' | 'caption' | 'component' | 'hideNextButton' | 'hidePlayButton' | 'hidePreviousButton' | 'icon' | 'label' | 'layout' | 'loop' | 'playRate' | 'position' | 'referenceElement' | 'values'>>, StencilJsx.HTMLAttributes<HTMLArcgisValuePickerElement> {
...
interface StencilArcgisVersionManagement extends Partial<Pick<ArcgisVersionManagement, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'initialVersionInfos' | 'label' | 'messageOverrides' | 'mode' | 'pageSize' | 'position' | 'referenceElement' | 'versioningStates' | 'view'>>, StencilJsx.HTMLAttributes<HTMLArcgisVersionManagementElement> {
...
interface StencilArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisWeatherElement> {
...
interface StencilArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisZoomElement> {
...
interface ExposedElements {
  "arcgis-area-measurement-2d": StencilArcgisAreaMeasurement2d;
  "arcgis-area-measurement-3d": StencilArcgisAreaMeasurement3d;
  "arcgis-attachments": StencilArcgisAttachments;
  "arcgis-basemap-gallery": StencilArcgisBasemapGallery;
  "arcgis-basemap-layer-list": StencilArcgisBasemapLayerList;
  "arcgis-basemap-toggle": StencilArcgisBasemapToggle;
  "arcgis-bookmarks": StencilArcgisBookmarks;
  "arcgis-building-explorer": StencilArcgisBuildingExplorer;
  "arcgis-catalog-layer-list": StencilArcgisCatalogLayerList;
  "arcgis-compass": StencilArcgisCompass;
  "arcgis-coordinate-conversion": StencilArcgisCoordinateConversion;
  "arcgis-daylight": StencilArcgisDaylight;
  "arcgis-directional-pad": StencilArcgisDirectionalPad;
  "arcgis-directions": StencilArcgisDirections;
  "arcgis-directline-measurement-3d": StencilArcgisDirectlineMeasurement3d;
  "arcgis-distance-measurement-2d": StencilArcgisDistanceMeasurement2d;
  "arcgis-editor": StencilArcgisEditor;
  "arcgis-elevation-profile": StencilArcgisElevationProfile;
  "arcgis-expand": StencilArcgisExpand;
  "arcgis-feature": StencilArcgisFeature;
  ...
  "arcgis-floor-filter": StencilArcgisFloorFilter;
  "arcgis-fullscreen": StencilArcgisFullscreen;
  "arcgis-histogram": StencilArcgisHistogram;
  "arcgis-histogram-range-slider": StencilArcgisHistogramRangeSlider;
  "arcgis-home": StencilArcgisHome;
  "arcgis-layer-list": StencilArcgisLayerList;
  "arcgis-legend": StencilArcgisLegend;
  "arcgis-line-of-sight": StencilArcgisLineOfSight;
  "arcgis-link-chart": StencilArcgisLinkChart;
  "arcgis-link-chart-layout-switcher": StencilArcgisLinkChartLayoutSwitcher;
  "arcgis-locate": StencilArcgisLocate;
  "arcgis-map": StencilArcgisMap;
  ...
  "arcgis-placement": StencilArcgisPlacement;
  "arcgis-print": StencilArcgisPrint;
  "arcgis-scale-bar": StencilArcgisScaleBar;
  "arcgis-scale-range-slider": StencilArcgisScaleRangeSlider;
  ...
  "arcgis-slice": StencilArcgisSlice;
  "arcgis-slider": StencilArcgisSlider;
  "arcgis-swipe": StencilArcgisSwipe;
  "arcgis-table-list": StencilArcgisTableList;
  "arcgis-time-slider": StencilArcgisTimeSlider;
  "arcgis-track": StencilArcgisTrack;
  "arcgis-utility-network-associations": StencilArcgisUtilityNetworkAssociations;
  "arcgis-utility-network-trace": StencilArcgisUtilityNetworkTrace;
  "arcgis-utility-network-validate-topology": StencilArcgisUtilityNetworkValidateTopology;
  "arcgis-value-picker": StencilArcgisValuePicker;
  "arcgis-version-management": StencilArcgisVersionManagement;
  "arcgis-weather": StencilArcgisWeather;
  "arcgis-zoom": StencilArcgisZoom;
}
