...
interface LuminaArcgisAreaMeasurement2d extends Partial<Pick<ArcgisAreaMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisAreaMeasurement2dElement> {
...
interface LuminaArcgisAreaMeasurement3d extends Partial<Pick<ArcgisAreaMeasurement3d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisAreaMeasurement3dElement> {
...
interface LuminaArcgisAttachments extends Partial<Pick<ArcgisAttachments, 'autoDestroyDisabled' | 'capabilities' | 'displayType' | 'graphic' | 'hideAddButton' | 'hideAddSubmitButton' | 'hideCancelAddButton' | 'hideCancelUpdateButton' | 'hideDeleteButton' | 'hideErrorMessage' | 'hideProgressBar' | 'hideUpdateButton' | 'icon' | 'label' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisAttachmentsElement> {
...
interface LuminaArcgisBasemapGallery extends Partial<Pick<ArcgisBasemapGallery, 'activeBasemap' | 'autoDestroyDisabled' | 'disabled' | 'headingLevel' | 'icon' | 'label' | 'position' | 'referenceElement' | 'source'>>, h.JSX.HTMLAttributes<HTMLArcgisBasemapGalleryElement> {
...
interface LuminaArcgisBasemapToggle extends Partial<Pick<ArcgisBasemapToggle, 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'nextBasemap' | 'position' | 'referenceElement' | 'showTitle'>>, h.JSX.HTMLAttributes<HTMLArcgisBasemapToggleElement> {
...
interface LuminaArcgisBookmarks extends Partial<Pick<ArcgisBookmarks, 'autoDestroyDisabled' | 'bookmarks' | 'defaultCreateOptions' | 'defaultEditOptions' | 'disabled' | 'dragEnabled' | 'filterPlaceholder' | 'filterText' | 'hideFlow' | 'hideThumbnail' | 'hideTime' | 'icon' | 'label' | 'position' | 'referenceElement' | 'showAddBookmarkButton' | 'showCloseButton' | 'showCollapseButton' | 'showEditBookmarkButton' | 'showFilter' | 'showHeading'>>, h.JSX.HTMLAttributes<HTMLArcgisBookmarksElement> {
...
interface LuminaArcgisBuildingExplorer extends Partial<Pick<ArcgisBuildingExplorer, 'autoDestroyDisabled' | 'headingLevel' | 'hideDisciplines' | 'hideLevels' | 'hidePhases' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisBuildingExplorerElement> {
...
interface LuminaArcgisCatalogLayerList extends Partial<Pick<ArcgisCatalogLayerList, 'autoDestroyDisabled' | 'catalogLayer' | 'collapsed' | 'filterPlaceholder' | 'filterPredicate' | 'filterText' | 'headingLevel' | 'hideFlow' | 'hideStatusIndicators' | 'icon' | 'label' | 'listItemCreatedFunction' | 'minFilterItems' | 'position' | 'referenceElement' | 'selectedItems' | 'selectionMode' | 'showCloseButton' | 'showCollapseButton' | 'showErrors' | 'showFilter' | 'showHeading' | 'showTemporaryLayerIndicators' | 'visibilityAppearance'>>, h.JSX.HTMLAttributes<HTMLArcgisCatalogLayerListElement> {
...
interface LuminaArcgisCompass extends Partial<Pick<ArcgisCompass, 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisCompassElement> {
...
interface LuminaArcgisDaylight extends Partial<Pick<ArcgisDaylight, 'autoDestroyDisabled' | 'currentSeason' | 'dateOrSeason' | 'dayPlaying' | 'headingLevel' | 'hideDatePicker' | 'hideHeader' | 'hidePlayButtons' | 'hideShadowsToggle' | 'hideSunLightingToggle' | 'hideTimezone' | 'icon' | 'label' | 'playSpeedMultiplier' | 'position' | 'referenceElement' | 'timeSliderSteps' | 'yearPlaying'>>, h.JSX.HTMLAttributes<HTMLArcgisDaylightElement> {
  onarcgisReady?: EventHandler<HTMLArcgisDaylightElement["arcgisReady"]>;
}

interface LuminaArcgisDirectionalPad extends Partial<Pick<ArcgisDirectionalPad, 'autoDestroyDisabled' | 'disabled' | 'hideDirectionalButtons' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'showRotationResetButton' | 'showRotationSlider' | 'visualScale'>>, h.JSX.HTMLAttributes<HTMLArcgisDirectionalPadElement> {
...
interface LuminaArcgisDirections extends Partial<Pick<ArcgisDirections, 'apiKey' | 'autoDestroyDisabled' | 'headingLevel' | 'hideLayerDetails' | 'hideSaveAsButton' | 'hideSaveButton' | 'icon' | 'label' | 'layer' | 'maxStops' | 'position' | 'referenceElement' | 'routeLayerItemId' | 'searchProperties' | 'unit' | 'useDefaultRouteLayer'>>, h.JSX.HTMLAttributes<HTMLArcgisDirectionsElement> {
...
interface LuminaArcgisDirectlineMeasurement3d extends Partial<Pick<ArcgisDirectLineMeasurement3d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisDirectlineMeasurement3dElement> {
...
interface LuminaArcgisDistanceMeasurement2d extends Partial<Pick<ArcgisDistanceMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisDistanceMeasurement2dElement> {
...
interface LuminaArcgisElevationProfile extends Partial<Pick<ArcgisElevationProfile, 'autoDestroyDisabled' | 'hideChart' | 'hideClearButton' | 'hideLegend' | 'hideSelectButton' | 'hideSettingsButton' | 'hideSketchButton' | 'hideUniformChartScalingToggle' | 'hideUnitSelector' | 'highlightEnabled' | 'hoveredChartPosition' | 'icon' | 'input' | 'label' | 'position' | 'profiles' | 'referenceElement' | 'uniformChartScaling' | 'unit' | 'unitOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisElevationProfileElement> {
...
interface LuminaArcgisExpand extends Partial<Pick<ArcgisExpand, 'autoCollapse' | 'autoDestroyDisabled' | 'closeOnEsc' | 'collapseIcon' | 'collapseTooltip' | 'expanded' | 'expandIcon' | 'expandTooltip' | 'focusTrapEnabled' | 'group' | 'icon' | 'iconNumber' | 'label' | 'mode' | 'placement' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisExpandElement> {
  onarcgisReady?: EventHandler<HTMLArcgisExpandElement["arcgisReady"]>;
}

interface LuminaArcgisFeature extends Partial<Pick<ArcgisFeature, 'autoDestroyDisabled' | 'defaultPopupTemplateEnabled' | 'graphic' | 'headingLevel' | 'hideContentAttachments' | 'hideContentExpression' | 'hideContentFields' | 'hideContentMedia' | 'hideContentText' | 'hideLastEditInfo' | 'hideTitle' | 'icon' | 'label' | 'location' | 'map' | 'position' | 'referenceElement' | 'spatialReference'>>, h.JSX.HTMLAttributes<HTMLArcgisFeatureElement> {
...
interface LuminaArcgisFeatureForm extends Partial<Pick<ArcgisFeatureForm, 'autoDestroyDisabled' | 'feature' | 'formTemplate' | 'groupDisplay' | 'headingLevel' | 'icon' | 'label' | 'layer' | 'position' | 'referenceElement' | 'timeZone'>>, h.JSX.HTMLAttributes<HTMLArcgisFeatureFormElement> {
...
interface LuminaArcgisFeatureTable extends Partial<Pick<ArcgisFeatureTable, 'actionColumnConfig' | 'attachmentsEnabled' | 'attributeTableTemplate' | 'autoDestroyDisabled' | 'autoRefreshDisabled' | 'columnReorderingDisabled' | 'description' | 'editingEnabled' | 'filterBySelectionEnabled' | 'filterGeometry' | 'hiddenFields' | 'hideColumnDescriptions' | 'hideColumnMenuItemsSortAscending' | 'hideColumnMenuItemsSortDescending' | 'hideColumnMenus' | 'hideHeader' | 'hideMenu' | 'hideMenuItemsClearSelection' | 'hideMenuItemsDeleteSelection' | 'hideMenuItemsExportSelectionToCsv' | 'hideMenuItemsRefreshData' | 'hideMenuItemsSelectedRecordsShowAllToggle' | 'hideMenuItemsSelectedRecordsShowSelectedToggle' | 'hideMenuItemsToggleColumns' | 'hideMenuItemsZoomToSelection' | 'hideProgress' | 'hideSelectionColumn' | 'hideTooltips' | 'highlightDisabled' | 'highlightIds' | 'icon' | 'initialSize' | 'label' | 'layer' | 'layerItemId' | 'layers' | 'layerUrl' | 'maxSize' | 'menuConfig' | 'multipleSelectionDisabled' | 'multipleSortEnabled' | 'objectIds' | 'outFields' | 'pageIndex' | 'pageSize' | 'paginationEnabled' | 'position' | 'referenceElement' | 'relatedRecordsEnabled' | 'relatedTable' | 'relatedTables' | 'returnGeometryEnabled' | 'returnMEnabled' | 'returnZEnabled' | 'rowHighlightIds' | 'showLayerDropdown' | 'tableController' | 'tableDisabled' | 'tableParent' | 'tableTemplate' | 'timeExtent' | 'timeZone'>>, h.JSX.HTMLAttributes<HTMLArcgisFeatureTableElement> {
...
interface LuminaArcgisFeatureTemplates extends Partial<Pick<ArcgisFeatureTemplates, 'autoDestroyDisabled' | 'enableListScroll' | 'filterFunction' | 'filterText' | 'groupBy' | 'headingLevel' | 'hideFilter' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement' | 'selectionMode'>>, h.JSX.HTMLAttributes<HTMLArcgisFeatureTemplatesElement> {
...
interface LuminaArcgisFeatures extends Partial<Pick<ArcgisFeatures, 'actions' | 'autoDestroyDisabled' | 'collapsed' | 'content' | 'featureNavigationTop' | 'features' | 'featuresPerPage' | 'featuresTitle' | 'featureViewModelAbilities' | 'goToOverride' | 'headerActions' | 'headingLevel' | 'hideActionBar' | 'hideCloseButton' | 'hideFeatureMenuHeading' | 'hideFeatureNavigation' | 'hideFlow' | 'hideHeading' | 'hideSpinner' | 'icon' | 'includeDefaultActions' | 'initialDisplayMode' | 'label' | 'map' | 'position' | 'promises' | 'referenceElement' | 'selectedFeatureIndex' | 'showCollapseButton' | 'spatialReference' | 'timeZone'>>, h.JSX.HTMLAttributes<HTMLArcgisFeaturesElement> {
...
interface LuminaArcgisFloorFilter extends Partial<Pick<ArcgisFloorFilter, 'autoDestroyDisabled' | 'facility' | 'headingLevel' | 'icon' | 'label' | 'level' | 'longNames' | 'position' | 'referenceElement' | 'site'>>, h.JSX.HTMLAttributes<HTMLArcgisFloorFilterElement> {
  onarcgisReady?: EventHandler<HTMLArcgisFloorFilterElement["arcgisReady"]>;
}

interface LuminaArcgisFullscreen extends Partial<Pick<ArcgisFullscreen, 'autoDestroyDisabled' | 'element' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisFullscreenElement> {
...
interface LuminaArcgisHistogram extends Partial<Pick<ArcgisHistogram, 'autoDestroyDisabled' | 'average' | 'barCreatedFunction' | 'bins' | 'dataLineCreatedFunction' | 'dataLines' | 'icon' | 'label' | 'labelFormatFunction' | 'layout' | 'max' | 'min' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisHistogramElement> {
...
interface LuminaArcgisHistogramRangeSlider extends Partial<Pick<ArcgisHistogramRangeSlider, 'autoDestroyDisabled' | 'average' | 'barCreatedFunction' | 'bins' | 'dataLineCreatedFunction' | 'dataLines' | 'excludedBarColor' | 'icon' | 'includedBarColor' | 'label' | 'labelFormatFunction' | 'max' | 'min' | 'position' | 'precision' | 'rangeType' | 'referenceElement' | 'standardDeviation' | 'standardDeviationCount' | 'values'>>, h.JSX.HTMLAttributes<HTMLArcgisHistogramRangeSliderElement> {
...
interface LuminaArcgisHome extends Partial<Pick<ArcgisHome, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'viewpoint'>>, h.JSX.HTMLAttributes<HTMLArcgisHomeElement> {
...
interface LuminaArcgisLayerList extends Partial<Pick<ArcgisLayerList, 'autoDestroyDisabled' | 'catalogOptions' | 'collapsed' | 'dragEnabled' | 'filterPlaceholder' | 'filterPredicate' | 'filterText' | 'headingLevel' | 'hideCatalogLayerList' | 'hideFlow' | 'hideStatusIndicators' | 'icon' | 'knowledgeGraphOptions' | 'label' | 'listItemCreatedFunction' | 'minDragEnabledItems' | 'minFilterItems' | 'position' | 'referenceElement' | 'selectedItems' | 'selectionMode' | 'showCloseButton' | 'showCollapseButton' | 'showErrors' | 'showFilter' | 'showHeading' | 'showTemporaryLayerIndicators' | 'visibilityAppearance'>>, h.JSX.HTMLAttributes<HTMLArcgisLayerListElement> {
...
interface LuminaArcgisLegend extends Partial<Pick<ArcgisLegend, 'activeLayerInfos' | 'autoDestroyDisabled' | 'basemapLegendVisible' | 'headingLevel' | 'hideLayersNotInCurrentView' | 'icon' | 'label' | 'layerInfos' | 'legendStyle' | 'position' | 'referenceElement' | 'respectLayerDefinitionExpression' | 'respectLayerVisibilityDisabled'>>, h.JSX.HTMLAttributes<HTMLArcgisLegendElement> {
...
interface LuminaArcgisLineOfSight extends Partial<Pick<ArcgisLineOfSight, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisLineOfSightElement> {
...
interface LuminaArcgisLocate extends Partial<Pick<ArcgisLocate, 'autoDestroyDisabled' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'popupDisabled' | 'position' | 'referenceElement' | 'scale'>>, h.JSX.HTMLAttributes<HTMLArcgisLocateElement> {
...
interface LuminaArcgisMap extends Partial<Pick<ArcgisMap, 'autoDestroyDisabled' | 'background' | 'basemap' | 'basemapView' | 'constraints' | 'displayFilterDisabled' | 'extent' | 'fatalError' | 'floors' | 'graphics' | 'ground' | 'highlightOptions' | 'highlights' | 'ipsInfo' | 'itemId' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'resizeAlign' | 'rotation' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'timeZone' | 'viewpoint' | 'zoom'>>, ArcgisMapSetterTypes, h.JSX.HTMLAttributes<HTMLArcgisMapElement> {
...
interface LuminaArcgisMeasurement extends Partial<Pick<ArcgisMeasurement, 'activeTool' | 'areaUnit' | 'autoDestroyDisabled' | 'icon' | 'label' | 'linearUnit' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisMeasurementElement> {
...
interface LuminaArcgisNavigationToggle extends Partial<Pick<ArcgisNavigationToggle, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'navigationMode' | 'position' | 'referenceElement' | 'state'>>, h.JSX.HTMLAttributes<HTMLArcgisNavigationToggleElement> {
...
interface LuminaArcgisPlacement extends Partial<Pick<ArcgisPlacement, 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisPlacementElement> {
  onarcgisReady?: EventHandler<HTMLArcgisPlacementElement["arcgisReady"]>;
}

interface LuminaArcgisPrint extends Partial<Pick<ArcgisPrint, 'allowedFormats' | 'allowedLayouts' | 'autoDestroyDisabled' | 'exportedLinks' | 'extraParameters' | 'headingLevel' | 'icon' | 'includeDefaultTemplatesDisabled' | 'label' | 'portal' | 'position' | 'printServiceUrl' | 'referenceElement' | 'showPrintAreaEnabled' | 'templateCustomTextElements' | 'templateOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisPrintElement> {
...
interface LuminaArcgisScaleBar extends Partial<Pick<ArcgisScaleBar, 'autoDestroyDisabled' | 'barStyle' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'unit'>>, h.JSX.HTMLAttributes<HTMLArcgisScaleBarElement> {
  onarcgisReady?: EventHandler<HTMLArcgisScaleBarElement["arcgisReady"]>;
}

interface LuminaArcgisScaleRangeSlider extends Partial<Pick<ArcgisScaleRangeSlider, 'autoDestroyDisabled' | 'disabled' | 'hidePreview' | 'hideScaleMenusMaxScaleMenu' | 'hideScaleMenusMinScaleMenu' | 'icon' | 'label' | 'layer' | 'maxScale' | 'maxScaleLimit' | 'minScale' | 'minScaleLimit' | 'mode' | 'position' | 'referenceElement' | 'region'>>, h.JSX.HTMLAttributes<HTMLArcgisScaleRangeSliderElement> {
...
interface LuminaArcgisScene extends Partial<Pick<ArcgisScene, 'alphaCompositingEnabled' | 'analyses' | 'autoDestroyDisabled' | 'basemap' | 'basemapView' | 'camera' | 'cameraFov' | 'cameraHeading' | 'cameraPosition' | 'cameraTilt' | 'clippingArea' | 'constraints' | 'displayFilterDisabled' | 'environment' | 'extent' | 'fatalError' | 'floors' | 'graphics' | 'ground' | 'highlightOptions' | 'highlights' | 'itemId' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'qualityProfile' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'viewingMode' | 'viewpoint' | 'zoom'>>, ArcgisSceneSetterTypes, h.JSX.HTMLAttributes<HTMLArcgisSceneElement> {
...
interface LuminaArcgisSlice extends Partial<Pick<ArcgisSlice, 'autoDestroyDisabled' | 'excludedLayers' | 'excludeGroundSurface' | 'headingLevel' | 'icon' | 'label' | 'position' | 'referenceElement' | 'shape' | 'tiltEnabled'>>, h.JSX.HTMLAttributes<HTMLArcgisSliceElement> {
...
interface LuminaArcgisSwipe extends Partial<Pick<ArcgisSwipe, 'autoDestroyDisabled' | 'direction' | 'disabled' | 'hideDivider' | 'hideHandle' | 'icon' | 'label' | 'leadingLayers' | 'messageOverrides' | 'position' | 'referenceElement' | 'swipePosition' | 'trailingLayers'>>, h.JSX.HTMLAttributes<HTMLArcgisSwipeElement> {
...
interface LuminaArcgisTimeSlider extends Partial<Pick<ArcgisTimeSlider, 'actions' | 'autoDestroyDisabled' | 'disabled' | 'fullTimeExtent' | 'icon' | 'label' | 'layout' | 'loop' | 'mode' | 'playRate' | 'position' | 'referenceElement' | 'stops' | 'tickConfigs' | 'timeExtent' | 'timeVisible' | 'timeZone'>>, h.JSX.HTMLAttributes<HTMLArcgisTimeSliderElement> {
...
interface LuminaArcgisTrack extends Partial<Pick<ArcgisTrack, 'autoDestroyDisabled' | 'error' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'positionFilterFunction' | 'referenceElement' | 'scale'>>, h.JSX.HTMLAttributes<HTMLArcgisTrackElement> {
...
interface LuminaArcgisVersionManagement extends Partial<Pick<ArcgisVersionManagement, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'initialVersionInfos' | 'label' | 'messageOverrides' | 'mode' | 'pageSize' | 'position' | 'referenceElement' | 'versioningStates' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisVersionManagementElement> {
...
interface LuminaArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisWeatherElement> {
...
interface LuminaArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisZoomElement> {
...
declare module "@arcgis/lumina" {
  export namespace h.JSX {
    interface IntrinsicElements {
      "arcgis-area-measurement-2d": LuminaArcgisAreaMeasurement2d;
      "arcgis-area-measurement-3d": LuminaArcgisAreaMeasurement3d;
      ...
      "arcgis-daylight": LuminaArcgisDaylight;
      "arcgis-directional-pad": LuminaArcgisDirectionalPad;
      "arcgis-directions": LuminaArcgisDirections;
      "arcgis-directline-measurement-3d": LuminaArcgisDirectlineMeasurement3d;
      "arcgis-distance-measurement-2d": LuminaArcgisDistanceMeasurement2d;
      "arcgis-editor": LuminaArcgisEditor;
      "arcgis-elevation-profile": LuminaArcgisElevationProfile;
      "arcgis-expand": LuminaArcgisExpand;
      "arcgis-feature": LuminaArcgisFeature;
      ...
      "arcgis-floor-filter": LuminaArcgisFloorFilter;
      "arcgis-fullscreen": LuminaArcgisFullscreen;
      "arcgis-histogram": LuminaArcgisHistogram;
      "arcgis-histogram-range-slider": LuminaArcgisHistogramRangeSlider;
      "arcgis-home": LuminaArcgisHome;
      "arcgis-layer-list": LuminaArcgisLayerList;
      "arcgis-legend": LuminaArcgisLegend;
      "arcgis-line-of-sight": LuminaArcgisLineOfSight;
      "arcgis-link-chart": LuminaArcgisLinkChart;
      "arcgis-link-chart-layout-switcher": LuminaArcgisLinkChartLayoutSwitcher;
      "arcgis-locate": LuminaArcgisLocate;
      "arcgis-map": LuminaArcgisMap;
      "arcgis-measurement": LuminaArcgisMeasurement;
      "arcgis-navigation-toggle": LuminaArcgisNavigationToggle;
      "arcgis-oriented-imagery-viewer": LuminaArcgisOrientedImageryViewer;
      "arcgis-placement": LuminaArcgisPlacement;
      "arcgis-print": LuminaArcgisPrint;
      "arcgis-scale-bar": LuminaArcgisScaleBar;
      "arcgis-scale-range-slider": LuminaArcgisScaleRangeSlider;
      ...
      "arcgis-slice": LuminaArcgisSlice;
      ...
      "arcgis-utility-network-associations": LuminaArcgisUtilityNetworkAssociations;
      "arcgis-utility-network-trace": LuminaArcgisUtilityNetworkTrace;
      "arcgis-utility-network-validate-topology": LuminaArcgisUtilityNetworkValidateTopology;
      "arcgis-value-picker": LuminaArcgisValuePicker;
      "arcgis-version-management": LuminaArcgisVersionManagement;
      "arcgis-weather": LuminaArcgisWeather;
      "arcgis-zoom": LuminaArcgisZoom;
    }
  }
}