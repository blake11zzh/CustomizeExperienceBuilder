...
import { makeAccessorController as c, reEmitEvent as t, accessorSupport as w } from "@arcgis/components-controllers/accessor";
import { watch as a } from "@arcgis/core/core/reactiveUtils.js";
import v from "@arcgis/core/views/SceneView.js";
import d from "@arcgis/core/WebScene.js";
import { LitElement as l, createEvent as r, noShadowRoot as g } from "@arcgis/lumina";
import { c as h, p as n, e as o, i as p } from "../../chunks/component-utils.js";
import { css as y } from "@lit/reactive-element/css-tag.js";
/*! All material copyright Esri, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.32/esri/copyright.txt for details.
v4.32.1 */
const u = y`@layer{arcgis-scene{display:block;height:100%;.esri-view{height:100%;width:100%}}}`, f = c(d, {}), _ = c(v, {});
class b extends l {
  constructor() {
  ...
  set itemId(i) {
    this._itemId = i, this.ready && w.reCreate(this._map, this).then(() => {
  ...
  set viewpoint(i) {
    this.ready && p(this.viewpoint, i) && (this.view.viewpoint = i), this._viewpoint = i;
  }
  /**
