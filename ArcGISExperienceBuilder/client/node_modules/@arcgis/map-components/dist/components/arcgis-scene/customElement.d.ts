 ...
 *    arcgisScene.addLayer(layer);
 * });
 * ```
 *
 * See also the [SDK sample apps using the Scene component](https://developers.arcgis.com/javascript/latest/sample-code/?tagged=arcgis-scene).
 */
