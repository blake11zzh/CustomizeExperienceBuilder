...
import d from "@arcgis/core/views/LinkChartView.js";
import l from "@arcgis/core/WebLinkChart.js";
import { LitElement as p, createEvent as a, noShadowRoot as m } from "@arcgis/lumina";
...
v4.32.1 */
const u = y`@layer{.arcgis-link-chart{padding:0;margin:0;height:100%;width:100%}}`, f = r(
  l,
  /**
...
class _ extends p {
  ...
  set center(i) {
    const e = h(i, this.ready ? this.view : void 0);
