...
export interface WebChartAxis {
    ...
    buffer?: boolean;
    /**
     * The desired minimum distance between two adjacent axis ticks. The actual distance may fluctuate depending on the chart's size.
     * When not provided a default value is assigned according to the axis type and axis labels behavior.
     * @minimum 1
     */
    tickSpacing?: number;
}
 ...
 */
export type WebChartSeriesType = WebChartBarChartSeries | WebChartBoxPlotSeries | WebChartGaugeSeries | WebChartHistogramSeries | WebChartLineChartSeries | WebChartPieChartSeries | WebChartRadarChartSeries | WebChartScatterPlotSeries;
/**
