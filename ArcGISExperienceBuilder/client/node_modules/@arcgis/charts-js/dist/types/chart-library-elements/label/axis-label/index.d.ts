import type { Axis } from "@amcharts/amcharts4/charts";
import type { Label } from "@amcharts/amcharts4/core";
import type { WebChartAxis, WebChartText } from "@arcgis/charts-spec";
import { WebChartLabelBehavior, WebChartTypes } from "@arcgis/charts-spec";
/**
 * Hides or shows the last label on the axis, whether it's cut off on the edge or not.
 * @param props.axis The axis
 * @param props.labels The labels to look at. If not provided, the default axis labels are used.
 * @param props.restoreLabelsVisibility Whether to restore the labels visibility
 */
export declare function toggleLastCutOffLabel(props: {
    axis: Axis;
    labels?: Label[];
    restoreLabelsVisibility?: boolean;
}): void;
/**
 ...
 * @param props.axis The axis
 * @param props.labelsConfig The labels configuration
