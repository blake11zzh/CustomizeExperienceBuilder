...
import type { TrendlineDataProps } from "./interfaces";
/**
 * Uses a `linear` function to calculate the trendline data from the main series' data.
 * @param props
 */
export declare function getFinalTrendLineDataClientSide(props: Omit<TrendlineDataProps, "queryObject">, securePoints?: boolean): {
    r2: number;
