...
import type { IRendererSymbol, ISimpleFillSymbol, ISimpleLineSymbol, ISimpleMarkerSymbol, WebChart, WebChartDataItem, WebChartSeriesType, WebMapWebChart } from "@arcgis/charts-spec";
...
export declare function computeRendererSymbol(props: {
    ...
    splitByField?: string;
    supportSymbolUtils: __esri.symbolUtils;
