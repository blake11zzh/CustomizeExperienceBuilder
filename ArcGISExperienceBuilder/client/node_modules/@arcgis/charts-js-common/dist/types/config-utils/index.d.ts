 ...
 */
export declare function hasTimeIntervalInfoBeenReset(oldConfig: WebMapWebChart, newConfig: WebMapWebChart): boolean;
/**
 ...
 * @returns
 */
export declare function hasAnyGuideAboveChanged(oldConfig: WebMapWebChart, newConfig: WebMapWebChart): boolean;
/**
