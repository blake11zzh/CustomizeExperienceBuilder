...
export interface ExportChartImageOptions {
    ...
    quality?: number;
    /** min width for the exported image */
    minWidth?: number;
    /** max width for the exported image */
    maxWidth?: number;
    /** min height for the exported image */
    minHeight?: number;
    /** max height for the exported image */
    maxHeight?: number;
}
export interface ChartInstance {
    ...
    exportImage: (exportProps: ExportChartImageOptions) => Promise<File>;
}
/**
...
export interface ChartOptions {
    ...
    /**
     * Used to customize the way the secondary y-axis labels are rendered on a dual axis chart. The callback function can return an HTML
     * string and the tags will be interpreted properly.
     * Not available on gauge for now.
     */
