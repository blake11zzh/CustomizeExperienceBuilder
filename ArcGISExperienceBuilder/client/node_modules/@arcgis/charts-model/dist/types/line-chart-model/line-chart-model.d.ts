import type { Color, RESTSimpleLineSymbolStyle, RESTSimpleMarkerSymbolStyle, WebChart, WebChartLineChartSeries } from "@arcgis/charts-spec";
import type { ChartConfig } from "@arcgis/charts-shared-utils";
import { ModelWithColorMatch, ModelWithDataLabels, ModelWithYGuides, ModelWithLegend, ModelWithRotation, ModelWithXYAxes, ModelWithXGuides, ModelWithTemporalBinning } from "../mixins";
...
export declare class LineChartModel extends SerialChartModel {
    /**
     * Current configuration used for the line chart.
     */
    protected _config: ChartConfig<WebChartLineChartSeries, WebChart>;
    /**
    ...
    setup(params: ModelParams<ChartConfig<WebChartLineChartSeries>>): Promise<void>;
...
export interface LineChartModel extends ModelWithXYAxes, ModelWithTemporalBinning, ModelWithLegend, ModelWithColorMatch, ModelWithRotation, ModelWithDataLabels, ModelWithXGuides, ModelWithYGuides {
}
