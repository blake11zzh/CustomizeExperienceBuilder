...
type SerialChartType = typeof WebChartTypes.BarSeries | typeof WebChartTypes.ComboLineAndBarSeries | typeof WebChartTypes.LineSeries;
...
export type SerialChartTypes = Extract<WebChartTypes, SerialChartType>;
...
/**
 * Gets the fields listed in the `orderByFields` property of a chart config.
 * @param {WebChart | WebMapWebChart} chartConfig -  The chart config
 * @returns {string[]} The list of fields to sort by
 */
export declare function getOrderByFields(chartConfig: WebChart | WebMapWebChart): string[];
/**
...
/**
 * Util function to know if the selection data changed.
 * The selection items and selection OIDs are compared, not the selection source nor the selection indexes.
 * @param selectionA The first selection data
 * @param selectionB The second selection data
 * @returns a boolean indicating whether the two selections are equal
 */
export declare function hasSelectionChanged(selectionA?: SelectionData, selectionB?: SelectionData): boolean;
/**
 * Indicates whether the selection data is empty.
 * @param selectionData The selection data to check
 */
export declare function isSelectionEmpty(selectionData: SelectionData | undefined): boolean;
export {};
