import type { SupportedLayer, WebGaugeChart, WebMapWebChart, WebMapWebGaugeChart } from "@arcgis/charts-spec";
 ...
 */
export declare function convertChartSpec<T extends WebGaugeChart | WebMapWebChart | WebMapWebGaugeChart>(config?: T, layerOrLayerView?: FeatureLayerView | SupportedLayer): Promise<T>;
