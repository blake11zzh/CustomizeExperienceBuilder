...
const ArcgisChartsConfigColorStyle = class {
    constructor(hostRef) {
        ...
        this.arcgisChartsConfigColorStyleChange = index.createEvent(this, "arcgisChartsConfigColorStyleChange", 7);
        this.arcgisChartsConfigColorStyleClose = index.createEvent(this, "arcgisChartsConfigColorStyleClose", 7);
        /**
     ...
     */
    render() {
        return (index.h(index.Host, { key: 'b50e22358bbb59a9ff3a2a891bb1ad7d3936f5f6' }, index.h("calcite-panel", { key: 'f4d233ed1ae74b6dfbfc01d0ae6a6306a3f603a5', heading: this.header ?? this.strings.header, closed: this.open === false, closable: this.enableClose, onCalcitePanelClose: this.closePanel }, index.h("div", { key: 'b7318596eff23fe15c1f778a83624ebe19783be9', class: HTMLClasses$1.colorStyleContainer }, index.h("arcgis-charts-config-colors", { key: 'e72288a17ccc4f2a8d7a5fcae244671f9be13c78', onColorSelect: this.colorChange, rgba: this.selectedColor })))));
    }
...
const ArcgisChartsConfigLineStyle = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.arcgisChartsConfigLineStyleChange = index.createEvent(this, "arcgisChartsConfigLineStyleChange", 7);
        this.arcgisChartsConfigLineStyleClose = index.createEvent(this, "arcgisChartsConfigLineStyleClose", 7);
        /**
         * @category Event handler
         */
        this.closePanel = (e) => {
        ...
        this.widthChange = () => {
            ...
            if (value !== undefined &&
                chartUiUtils.isCalciteInputValidNumber(value, this.lineWidthInputElement.min, this.lineWidthInputElement.max)) {
    ...
    render() {
        const configurationUI = [
            index.h("div", { key: 'ffb9d029bda4518ad7a2c741edb975a73499de1c', class: HTMLClasses.sizeSection }, index.h("calcite-label", { key: '04bc8db5062d2dafc459d93dc5ddb175c68416a7' }, this.strings.style, index.h("calcite-dropdown", { key: 'd13018c9b957fffede243ae116677705054753a0', onCalciteDropdownSelect: this.lineStyleChange, ref: (e) => {
                    this.lineStyleDropdownElement = e;
                } }, index.h("calcite-button", { key: 'c160e194fd50461546345202513faf2a3922b200', iconEnd: this.selectedLineStyle().icon, slot: "trigger", kind: "neutral", appearance: "outline-fill", scale: "m" }, index.h("label", { key: 'b4babfa586ce7855a7d798d8a47f589d7ff7ab86', class: HTMLClasses.dropdownText }, this.selectedLineStyle().style)), index.h("calcite-dropdown-group", { key: '91e5d973bc12bbf73e7771fda1587906b7d56e5d' }, index.h("calcite-dropdown-item", { key: '3708b73623caee3cfdaf43880f41d5d7a85db3d9', iconEnd: "line-solid", selected: this.lineStyle?.style === restJsObjectLiterals.RESTSimpleLineSymbolStyle.Solid, accessKey: restJsObjectLiterals.RESTSimpleLineSymbolStyle.Solid }, this.strings.solid), index.h("calcite-dropdown-item", { key: 'cd867a08bd4ea706db70045413358926b8b1112d', iconEnd: "line-dotted", selected: this.lineStyle?.style === restJsObjectLiterals.RESTSimpleLineSymbolStyle.Dot, accessKey: restJsObjectLiterals.RESTSimpleLineSymbolStyle.Dot }, this.strings.dot), index.h("calcite-dropdown-item", { key: '36f7be35cd98e53497dbe151645411b64975c81c', iconEnd: "line-dashed", selected: this.lineStyle?.style === restJsObjectLiterals.RESTSimpleLineSymbolStyle.Dash, accessKey: restJsObjectLiterals.RESTSimpleLineSymbolStyle.Dash }, this.strings.dash)))), index.h("calcite-label", { key: '50bc1c39c575f4c7ee8146f99d0164309fa96869' }, this.strings.width, index.h("calcite-input", { key: '483565e6e137fe70378967b09a0ccfd6df30c542', type: "number", min: 1, step: "any", value: chartUiUtils.sanitizeNumber(this.lineStyle?.width), onCalciteInputInput: this.widthChange, ref: (e) => {
                    this.lineWidthInputElement = e;
                } }))),
            index.h("div", { key: '63993ae9c847300d1cbb35ef201015a6430fa997', class: HTMLClasses.colorPickerContainer }, index.h("arcgis-charts-config-colors", { key: 'a5fda2ff9bb39963a2d174dcd289eb497376b160', rgba: this.lineStyle?.color ?? undefined, onColorSelect: this.colorChange })),
        ];
        return (index.h(index.Host, { key: '85f53f8745e8088bcca329ded0ecee25ddad1504' }, this.usePanel !== false ? (index.h("calcite-panel", { heading: this.header ?? this.strings.header, closed: this.open === false, closable: this.enableClose, onCalcitePanelClose: this.closePanel }, configurationUI)) : (configurationUI)));
    }
    /**
     * @category Private
     */
...
exports.arcgis_charts_config_color_style = ArcgisChartsConfigColorStyle;
exports.arcgis_charts_config_line_style = ArcgisChartsConfigLineStyle;
