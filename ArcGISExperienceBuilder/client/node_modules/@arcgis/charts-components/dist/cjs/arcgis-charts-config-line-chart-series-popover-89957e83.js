...
const ArcgisChartsConfigLineChartSeriesPopover = class {
    constructor(hostRef) {
        ...
        this.lineWidthChange = () => {
            ...
            if (this.lineWidthInputElement.value !== undefined &&
                chartUiUtils.isCalciteInputValidNumber(lineWidth, this.lineWidthInputElement.min, this.lineWidthInputElement.max)) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '587fe2dd26130aef94407d70b13db71a5e2a2ced', class: HTMLClasses.jsAppFlyout }, index.h("calcite-popover", { key: '9f17845eb8d071afe0c4c8fe07d7ea1a0a406e24', referenceElement: this.referenceElement, placement: this.placement, onCalcitePopoverClose: this.closePopover, open: this.open, ref: (e) => {
                this.popoverElement = e;
            }, label: "" }, index.h("calcite-panel", { key: '0d7a8d4ec17fd60fa09dc0dfbf372e6e3cc8491f', heading: this.strings.seriesElement, closable: true, closed: !this.open, onCalcitePanelClose: this.closePopover }, index.h("div", { key: 'b2d30255c6fc1ff9a15ee9f8bf8e06bbc2f40306', class: HTMLClasses.panelChildrenContainer }, index.h("calcite-label", { key: '2d895f56b0041e08ad0e4f55b46d5e33fd7aa11b' }, this.strings.label, index.h("calcite-input", { key: 'dde6de34af42f3c71d89c28e6f6eaa2ab4f17334', type: "text", value: this.selectedName, onCalciteInputInput: this.seriesNameChange }))), index.h("div", { key: '6b1c1d09585b2d4dd2e2c3188bad774c93a69e78', class: HTMLClasses.sizeSection }, index.h("calcite-label", { key: '5e7c3e2952f958475a0f86ffcb0613d158d2ddd3' }, this.strings.style, index.h("calcite-dropdown", { key: 'bad815be3b78fb4041fa3836e6ef55ed66830b7e', onCalciteDropdownSelect: this.lineStyleChange, ref: (e) => {
                this.lineStyleDropdownElement = e;
            } }, index.h("calcite-button", { key: '21d3dec2f30ea4dbd5f566e5ae490e6a6bf5c79f', iconEnd: this.getSelectedLineStyleInfo().icon, slot: "trigger", kind: "neutral", appearance: "outline-fill" }, index.h("label", { key: '588837c87aa7e68ed15362162c24c5783c8b5ee2', class: HTMLClasses.dropdownText }, this.getSelectedLineStyleInfo().style)), index.h("calcite-dropdown-group", { key: 'b53a9a71f27cf4948e63430e4635eadab736ec50' }, index.h("calcite-dropdown-item", { key: '57b51ebebe50b28da5ec184b0ed9c68135119217', iconEnd: "line-solid", selected: this.selectedLineStyle === restJsObjectLiterals.RESTSimpleLineSymbolStyle.Solid, accessKey: restJsObjectLiterals.RESTSimpleLineSymbolStyle.Solid }, this.strings.solid), index.h("calcite-dropdown-item", { key: 'a4e88609e9ac6758cfd44c7ab25de1ff095be7ee', iconEnd: "line-dotted", selected: this.selectedLineStyle === restJsObjectLiterals.RESTSimpleLineSymbolStyle.Dot, accessKey: restJsObjectLiterals.RESTSimpleLineSymbolStyle.Dot }, this.strings.dot), index.h("calcite-dropdown-item", { key: 'ca72e3e3605e292ff580683c311b5f763e7fc1a1', iconEnd: "line-dashed", selected: this.selectedLineStyle === restJsObjectLiterals.RESTSimpleLineSymbolStyle.Dash, accessKey: restJsObjectLiterals.RESTSimpleLineSymbolStyle.Dash }, this.strings.dash)))), index.h("calcite-label", { key: '96387b143014f68cee3450ae09548cdd59b85a5b' }, this.strings.width, index.h("calcite-input", { key: '42792b09b36279f3c400af25225ae962d8e168dc', type: "number", min: 1, step: "any", value: chartUiUtils.sanitizeNumber(this.selectedLineWidth), onCalciteInputInput: this.lineWidthChange, ref: (e) => {
                this.lineWidthInputElement = e;
            } }))), index.h("div", { key: '91a38d29958b95bf621ec76bca1ab703a70e3c1b', class: HTMLClasses.panelChildrenContainer }, index.h("arcgis-charts-config-colors", { key: 'f2fe04e1b290eb84162f1dba5e03814d8f5ff137', heading: this.strings.lineColor, rgba: rgba, onColorSelect: this.colorChange }))))));
    }
...
ArcgisChartsConfigLineChartSeriesPopover.style = ArcgisChartsConfigLineChartSeriesPopoverStyle0;

exports.ArcgisChartsConfigLineChartSeriesPopover = ArcgisChartsConfigLineChartSeriesPopover;
