...
function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
  ...
  if (isSameTag && _Map.isBuffer(object)) {
    if (!_Map.isBuffer(other)) {
      return false;
    }
    objIsArr = true;
    objIsObj = false;
  ...
  if (isSameTag && !objIsObj) {
    ...
    return (objIsArr || _Map.isTypedArray(object))
...
function baseIsEqual(value, other, bitmask, customizer, stack) {
  ...
  if (value == null || other == null || (!isObject.isObjectLike(value) && !isObject.isObjectLike(other))) {
