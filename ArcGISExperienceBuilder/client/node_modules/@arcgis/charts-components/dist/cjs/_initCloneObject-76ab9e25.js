...
function assignValue(object, key, value) {
  ...
  if (!(hasOwnProperty$1.call(object, key) && _Uint8Array.eq(objValue, value)) ||
...
function baseKeysIn(object) {
  ...
  var isProto = _Map.isPrototype(object),
      result = [];
...
function keysIn(object) {
  return _Map.isArrayLike(object) ? _Uint8Array.arrayLikeKeys(object, true) : baseKeysIn(object);
}

/** Built-in value references. */
var getPrototype = _Map.overArg(Object.getPrototypeOf, Object);
...
function initCloneObject(object) {
  return (typeof object.constructor == 'function' && !_Map.isPrototype(object))
