...
const ArcGISChartsConfigPieChartData = class {
    constructor(hostRef) {
        ...
        this.arcgisChartsConfigPieChartDataNumericFieldValidate = index.createEvent(this, "arcgisChartsConfigPieChartDataNumericFieldValidate", 7);
        ...
        this.onSortOrderSelect = () => {
            this.contentKind = interfaces.PieChartDataPopoverKinds.sortOrder;
            this.setupPopover();
        };
        /**
         * @category Event handler
        ...
        this.onCategorySelect = () => {
            this.contentKind = interfaces.PieChartDataPopoverKinds.category;
            this.setupPopover();
        };
        /**
         * @category Event handler
        ...
        this.onAddNumericFields = () => {
            this.contentKind = interfaces.PieChartDataPopoverKinds.numericFields;
            this.setupPopover();
        };
        /**
         * @category Event handler
                ...
                if (e.detail !== null && e.detail?.value !== undefined) {
                    ...
                    switch (contentKind) {
                        case interfaces.PieChartDataPopoverKinds.aggregation:
                            await this.model.setAggregationType(newValue[0] !== restJsObjectLiterals.RESTStatisticType.NoAggregation ? newValue[0] : "");
                            break;
                        case interfaces.PieChartDataPopoverKinds.category: {
                            ...
                            if (numericFields.length > 1 && newCategory !== chartUiUtils.defaultPieFromFieldsName) {
                        ...
                        case interfaces.PieChartDataPopoverKinds.numericFields:
                            ...
                            if (newValue.length > 1) {
                                this.updateMode(chartUiUtils.defaultPieFromFieldsName);
                                await this.model.setCategory(chartUiUtils.defaultPieFromFieldsName);
                            }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '71c159378eacd2102b08dedb9f490be7a0d61a16', class: { [HTMLClasses$1.rtl]: this.direction === "rtl" } }, index.h("calcite-label", { key: 'a4257387596421399c45874db20d7b4113afe2f9', class: HTMLClasses$1.label }, this.strings.category, categoryUI), [
            index.h("calcite-label", { key: 'fe2ce6294d26d51237ca0e37b25e6260bd4f2b30', class: HTMLClasses$1.label }, this.strings.numericFields, numericFieldsUI),
            index.h("div", { key: '0ff966420080f20ec8234ba8667cd95839fffb9f', class: HTMLClasses$1.fab }, index.h("calcite-fab", { key: '3471ebb056b44ee0dece3f44dc68a095f6c347d0', appearance: "outline-fill", kind: "neutral", scale: "m", label: this.strings.selectNumericFields, "text-enabled": true, text: this.strings.selectNumericFields, icon: "plus", onClick: this.onAddNumericFields })),
        ], index.h("calcite-label", { key: 'e954a0fb8a21d2f5ba855524bbbab292113f6763', class: HTMLClasses$1.label, layout: "inline-space-between" }, this.strings.showDataLabels, index.h("calcite-switch", { key: '211743ae23fe12a013d4d05b111b262678f5fe61', checked: this.model.getDataLabelsVisibility(), onCalciteSwitchChange: this.onShowDataLabelsChange })), index.h("calcite-label", { key: 'e53374c316407695d6dd52883eec9f86c6d4cf5d', class: HTMLClasses$1.label }, this.strings.sortOrder, sortingUI)));
    }
    /**
     * @category Private
     */
    updateMode(category) {
        const categoryMode = category !== chartUiUtils.defaultPieFromFieldsName && category.trim() !== "";
        this.model.setMode(categoryMode ? index$1.th.Category : index$1.th.Fields);
    }
    /**
     * @category Private
     */
    setupPopover() {
        ...
        this.pieChartPopover = restJsObjectLiterals.Zy(restJsObjectLiterals.Qy.PieChartDataPopover, popoverConfig);
    ...
    getCorrectedCategoryValue() {
        return this.model.getCategory() === chartUiUtils.defaultPieFromFieldsName || this.model.getCategory().trim() === ""
            ? ""
    ...
    removePieChartDataPopover() {
        if (this.pieChartPopover !== null) {
            ...
            this.pieChartPopover = restJsObjectLiterals.Jy(this.pieChartPopover);
        }
    }
...
const ArcGISChartsConfigPieChartSlices = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.arcgisChartsConfigPieChartSlicesPopoverChange = index.createEvent(this, "arcgisChartsConfigPieChartSlicesPopoverChange", 7);
         ...
         * @category Event handler
         */
        this.onDonutSizeSliderChange = debounce.debounce(() => {
            if (Number.isInteger(this.donutSizeSliderElement.value)) {
                this.model.setInnerRadiusSize(this.donutSizeSliderElement.value ?? restJsObjectLiterals.oa);
            }
        }, chartUiUtils.UIDefaults.SliderTimer);
        /**
         * @category Event handler
         */
        this.onGroupingThresholdSliderChange = debounce.debounce(() => {
    ...
    selectedSliceIdChange() {
        if (!isEmpty.isEmpty(this.selectedSliceId) && this.configSliceOpen) {
    ...
    removeSlicesPopover() {
        if (this.slicesPopover !== undefined && this.slicesPopover !== null) {
            ...
            this.slicesPopover = restJsObjectLiterals.Jy(this.slicesPopover);
        }
    ...
    buildSliceListItem() {
        ...
        slices?.forEach((eachSlice) => {
            ...
            if (eachSlice !== undefined && !this.model.getGroupedSliceIds().includes(eachSlice.sliceId)) {
                ...
                if (description === restJsObjectLiterals.Zn.emptySliceId) {
                    description = this.strings.emptySlice;
                }
                else if (description === restJsObjectLiterals.Zn.nullSliceId) {
                    description = this.strings.nullSlice;
                }
                sliceList?.push(index.h("calcite-list-item", { key: eachSlice.sliceId, label: eachSlice.label ?? eachSlice.sliceId, description: description, value: eachSlice.sliceId, selected: this.selectedSliceId === eachSlice.sliceId, onClick: this.openSlicesPopover }, index.h("calcite-icon", { slot: "content-end", icon: icon, style: { color: iconColor } })));
            }
        });
        const sliceGrouping = this.model.getSliceGrouping();
        ...
        if (this.model.getGroupedSliceIds().length > 0) {
            sliceList?.push(index.h("calcite-list-item", { key: sliceGrouping?.sliceId, label: sliceGrouping?.label ?? sliceGrouping?.sliceId ?? "", description: this.strings.groupedSlices, value: sliceGrouping?.sliceId ?? "", selected: this.selectedSliceId === sliceGrouping?.sliceId, onClick: this.openSlicesPopover }, index.h("calcite-icon", { slot: "content-end", icon: icon, style: { color: iconColor } })));
        }
        return sliceList;
    }
    /**
    ...
    buildGroupedSlicesListItem() {
        ...
        this.model.getSlices()?.forEach((eachSlice) => {
            ...
            if (eachSlice !== undefined && this.model.getGroupedSliceIds().includes(eachSlice.sliceId)) {
                sliceList?.push(index.h("calcite-list-item", { key: eachSlice.sliceId, label: eachSlice.label ?? eachSlice.sliceId, description: eachSlice.sliceId, value: eachSlice.sliceId, selected: this.selectedSliceId === eachSlice.sliceId, onClick: this.openSlicesPopover }, index.h("calcite-icon", { slot: "content-end", icon: icon, style: { color: iconColor } })));
            }
        });
        return sliceList;
    }
     ...
     */
    buildSliceList() {
        return (index.h("calcite-list", { label: "", class: HTMLClasses.sliceList, selectionMode: "single", selectionAppearance: "border", onCalciteListOrderChange: this.onCalciteListOrderChange }, this.buildSliceListItem()));
    }
    /**
     * @category Render UX
     */
    buildGroupedSliceList() {
        return (index.h("calcite-list", { label: "", class: HTMLClasses.sliceList, selectionMode: "single", selectionAppearance: "border", onCalciteListOrderChange: this.onCalciteListOrderChange }, this.buildGroupedSlicesListItem()));
    }
    /**
     * @category Lifecycle
     */
    render() {
        return (index.h(index.Host, { key: '293ddf3eb0fc2a0f6ddee6d6d7d67f83a581eddc' }, index.h("div", { key: '33736708d4bf2fd7ab4f2daea0250348000f0091', class: HTMLClasses.sectionLabel }, this.strings.settings), index.h("calcite-label", { key: 'b460ef6df43c4fa27874da0627067cc9da9be74c', class: HTMLClasses.label }, this.strings.shape, index.h("calcite-slider", { key: '4d2a71ed4ff75b3490872ac514d2662504ee6f70', labelHandles: false, min: 0, max: 100, step: 1, snap: true, value: this.model.getInnerRadiusSize() ?? restJsObjectLiterals.oa, onCalciteSliderChange: this.onDonutSizeSliderChange, ref: (e) => {
                this.donutSizeSliderElement = e;
            } })), index.h("div", { key: '55b78f6fbaae0f57e5ac7ff8cda76d037fe5224f', class: HTMLClasses.pieDonutLabelsContainer }, index.h("calcite-label", { key: '2be88abd27cb7dd021ec4a50572a1062fa68f1a1', class: HTMLClasses.label }, this.strings.pie), index.h("calcite-label", { key: '3ebc0cb1e920ea29098a3985707b014eb0fb21cf', class: HTMLClasses.label }, this.strings.donut)), index.h("calcite-label", { key: '30ade5368a4b77b8c437403885e05f2ef1a47cf0', class: HTMLClasses.label }, index.h("div", { key: '692439e410c9d1ae400b14535511b03a6f5d4472', class: HTMLClasses.groupingLabelContainer }, index.h("div", { key: 'd9731959878d99243a0595d5bd217676cb265e16' }, this.strings.groupingPercent), index.h("calcite-icon", { key: '3c1d5035d3f130efc26ae9dd983cdd1b1b4fac34', icon: "information", scale: "s", flipRtl: true, onMouseOver: this.createTooltip, onMouseOut: this.destroyTooltip })), index.h("div", { key: '0055f28f084b6786d9975ab003d8acda8972933c', class: HTMLClasses.sliderInputContainer }, index.h("calcite-slider", { key: 'd8984e35a7e76fc265b80d7ebc7153411a4af28f', labelHandles: false, min: 0, max: 50, step: 1, snap: true, value: toNumber.toNumber(chartUiUtils.sanitizeNumber(this.model.getGroupingThreshold() ?? 0)), onCalciteSliderChange: this.onGroupingThresholdSliderChange, ref: (e) => {
                this.groupingThresholdSliderElement = e;
            } }), index.h("calcite-input", { key: 'af4d17930b74105701c70bd659f13a30eb8b05a0', class: HTMLClasses.numberInput, type: "number", min: 0, max: 100, step: 1, suffixText: "%", value: chartUiUtils.sanitizeNumber(this.model.getGroupingThreshold() ?? 0), onCalciteInputInput: this.onGroupingThresholdChange, ref: (e) => {
            ...
            } }))), index.h("div", { key: '9b59c69fac201710189b16ff7165c0f8f78ca566', class: HTMLClasses.sectionLabel }, this.strings.labels), index.h("calcite-label", { key: '8b00f14ac794850d5d17d8b3810f1ee03d27f1ab', class: HTMLClasses.label }, this.strings.labelCharacterLimit, index.h("calcite-input", { key: 'c4fa9c3397c4e11350cb2508b8347d79e41b8658', type: "number", min: 1, step: 1, value: chartUiUtils.sanitizeNumber(this.model.getLabelCharacterLimit()), onCalciteInputInput: this.onLabelCharacterLimitChange, ref: (e) => {
                this.labelCharacterLimitElement = e;
            } })), index.h("calcite-label", { key: '6d43bcb7ba905e78457f2f87cd78a29b4fdc3c56', class: HTMLClasses.label }, this.strings.decimalPlaces, index.h("calcite-input", { key: 'df34a75495d81b26be2afc05bdce1fd5b1e3d490', type: "number", min: 0, max: 20, step: 1, value: chartUiUtils.sanitizeNumber(this.model.getDecimalPlaces()), onCalciteInputInput: this.onDecimalPlacesChange, ref: (e) => {
                this.decimalPlacesElement = e;
            } })), index.h("calcite-label", { key: '504bd5145c4f3da5388ae41f9887cae7469b5490', class: HTMLClasses.label }, this.strings.display, index.h("calcite-radio-button-group", { key: 'abbcc323977b72eaa00283be8f7ef7f861b090a9', class: HTMLClasses.radioGroup, name: "display", layout: "vertical", onCalciteRadioButtonGroupChange: this.onDisplayTypeChange }, index.h("calcite-label", { key: '402b87bd856dc1b81298d3be73aba87e05df9a66', layout: "inline" }, index.h("calcite-radio-button", { key: '252d104dcf622fac9099913dec3f1c4c6f97c33c', value: index$1.rh.Value, checked: this.model.getDisplayType() === index$1.rh.Value }), this.strings.value), index.h("calcite-label", { key: 'eb97a15177a32a39c6837e7bc80ca9258aa87af6', layout: "inline" }, index.h("calcite-radio-button", { key: 'df37ae7085998b12708b1395e90c60f57b7d747b', value: index$1.rh.Percentage, checked: this.model.getDisplayType() === index$1.rh.Percentage }), this.strings.percentage), index.h("calcite-label", { key: 'acd24bb6ebf731490a84854e50cb328dfdc42475', layout: "inline" }, index.h("calcite-radio-button", { key: 'fe31aa327b130225544b0cbfd88c50c053ae8004', value: index$1.rh.Both, checked: this.model.getDisplayType() === index$1.rh.Both }), this.strings.both))), index.h("div", { key: 'cce8d301acb22ef81d523e376319b014b0a27102', class: HTMLClasses.sectionLabel }, this.strings.slices, index.h("calcite-button", { key: '25e0ff6b850ffcfff2b2ec105d3343e2a2c21b44', onClick: this.resetSlicesOriginal, disabled: !this.model.resetAvailable(), appearance: "transparent", iconEnd: "reset" }, this.strings.reset)), this.buildSliceList(), index.h("div", { key: '1a8965ba5c7a444779f4b2eb5b78b5a05180de20', class: HTMLClasses.sectionLabel }, this.strings.groupedSlices), this.buildGroupedSliceList()));
    }
    /**
     * @category Private
     */
    setupSlicesPopover() {
        if (this.slicesPopover === null && this.hostElement !== undefined) {
            ...
            this.slicesPopover = restJsObjectLiterals.Zy(restJsObjectLiterals.Qy.PieChartSlicesPopover, popoverConfig);
        }
    }
    /**
     * @category Private
...
exports.arcgis_charts_config_pie_chart_data = ArcGISChartsConfigPieChartData;
exports.arcgis_charts_config_pie_chart_slices = ArcGISChartsConfigPieChartSlices;
