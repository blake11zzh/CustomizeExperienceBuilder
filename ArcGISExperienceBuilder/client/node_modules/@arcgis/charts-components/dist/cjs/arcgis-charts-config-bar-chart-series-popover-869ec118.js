...
const ArcgisChartsConfigBarChartSeriesPopover = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '37911103ca43fcb8b76e173e91e869cdb41f8861', class: HTMLClasses.jsAppFlyout }, index.h("calcite-popover", { key: '9c947bea170f6ae44ff250fd1196d098a3052b2a', referenceElement: this.referenceElement, placement: this.placement, open: this.open, onCalcitePopoverClose: this.closePopover, ref: (e) => {
                this.popoverElement = e;
            }, label: "" }, index.h("calcite-panel", { key: 'b76203fbb93c091ebe1cd506cdf935c1e60799f4', heading: this.strings.seriesElement, closable: true, closed: !this.open, onCalcitePanelClose: this.closePopover }, index.h("div", { key: '88c83c4667ccefa4c8a2494d70b3e0c8d67d76fc', class: HTMLClasses.panelChildrenContainer }, index.h("calcite-label", { key: '5044f9cbad5ea9ad99ce6022f6664944a5f5a759' }, this.strings.label, index.h("calcite-input", { key: '13f390d339f2b0f7603a56e440cb3642bac63081', type: "text", value: this.selectedName, onCalciteInputInput: this.seriesNameChange }))), index.h("div", { key: '8a384652c750f78a25cc65862c69c0d5a87c37f3', class: HTMLClasses.panelChildrenContainer }, index.h("arcgis-charts-config-colors", { key: '5593755f47252b4f2bec85134b268101b4950fe6', heading: this.strings.symbolColor, rgba: rgba, onColorSelect: this.colorChange }))))));
    }
...
exports.ArcgisChartsConfigBarChartSeriesPopover = ArcgisChartsConfigBarChartSeriesPopover;
