...
import { R as RESTStatisticType, aa as wc, M as Mn, y as ta, C as Tl, ab as Cl, a as ts, m as ml, Z as Zy, r as Qy, a5 as Jy } from './rest-js-object-literals-a5a8eefc.js';
import { J as Jf } from './index-5e57070e.js';
import { B as BarChartDataPopoverKinds, c as ButtonDirections } from './interfaces-f2a30723.js';
import { d as deleteMinMaxAxisKey, s as state } from './store-b7e98551.js';
import { h as defaultBarLineFromFieldsName, U as UIDefaults, c as createActionTooltip, d as destroyActionTooltip } from './chart-ui-utils-0ccca40a.js';
import { i as isEqual } from './isEqual-963b8247.js';
import { W as WebChartTypes, e as WebChartStackedKinds } from './chart-object-literals-d22e2547.js';
...
const ArcGISChartsConfigBarChartData = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'd520b608238fe23846bb5b787944a6cebed1e97a', class: { [HTMLClasses$1.rtl]: this.direction === "rtl" } }, h("calcite-label", { key: '9d87db83f1a18be036e0ec77960db5e02bdb521c', class: HTMLClasses$1.label }, this.strings.category, categoryUI), h("calcite-label", { key: '1d48bd128c8c1df87d363021fabfb389f3a20ee6', class: HTMLClasses$1.label }, this.strings.aggregation, aggregationUI), h("calcite-label", { key: 'cd6d29c45d415f6bdc2ebe8c19540bb2536c42a5', class: HTMLClasses$1.label }, this.strings.numericFields, numericFieldsUI), h("div", { key: '576fd1a43d78a937bcb1698ef3d5d1f393c119e8', class: HTMLClasses$1.fab }, h("calcite-fab", { key: '31389b002023db711664d1259908efa14ebac2ef', appearance: "outline-fill", kind: "neutral", scale: "m", label: this.strings.selectNumericFields, "text-enabled": true, text: this.strings.selectNumericFields, icon: "plus", onClick: this.onAddNumericFields })), h("calcite-label", { key: '56536812fd8ba83ab3560588c6e4fb5584fee414', class: HTMLClasses$1.label }, h("span", { key: '22802f0cb6286e8e4ff80feb6b90ed6604622670', class: this.disableSplitBy ? HTMLClasses$1.dimText : "" }, this.strings.splitBy), splitByUI), h("calcite-label", { key: 'be78b831308f8c819475749a0cb4bb6fcb17e2b0', class: HTMLClasses$1.label, layout: "inline-space-between" }, this.strings.showDataLabels, h("calcite-switch", { key: '3cbc95d9741ea3a1e18920e0c031cc792150e701', checked: this.model.getDataLabelsVisibility(), onCalciteSwitchChange: this.onShowDataLabelsChange })), h("calcite-label", { key: '5b6e3f2996f9946b7e92aa2707c872b57884c7c3', class: this.model.getXAxisValueFormat()?.type === WebChartTypes.DateAxisFormat
...
export { ArcGISChartsConfigBarChartData as arcgis_charts_config_bar_chart_data, ArcGISChartsConfigBarChartSeries as arcgis_charts_config_bar_chart_series };
