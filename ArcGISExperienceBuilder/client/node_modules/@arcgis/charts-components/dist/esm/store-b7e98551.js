 ...
 * v4.32.1
 */
import { d as getRenderingRef, f as forceUpdate } from './index-accb48c0.js';
...
const chartAxesBoundDataMap = {};
const scatterPlotData = {};
const store = createStore({
    selectedChartId: "",
    chartAxesBoundDataMap,
    scatterPlotData,
});
const { state } = store;
/**
 ...
 */
const generateAxisMinMaxKey = (props) => {
    const { chartId, isXAxis, isLogarithmic } = props;
    return `${chartId}_${isXAxis ? "x" : "y"}${isLogarithmic ? "_log" : ""}`;
};
/**
 ...
 */
const deleteMinMaxAxisKey = (appState) => {
    const chartId = appState.selectedChartId;
    appState.chartAxesBoundDataMap[chartId] = undefined;
};

export { deleteMinMaxAxisKey as d, generateAxisMinMaxKey as g, state as s };
