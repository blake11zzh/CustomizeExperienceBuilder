...
import { M as Mn, af as na, A as Tl, ab as no, a2 as Jy, Z as Zy, r as Qy, E as Hn } from './index2.js';
import { f as isCalciteInputValidNumber, m as modifyCalciteInputStatus, l as formatNumberToLocale, s as sanitizeNumber, b as UIInputStatus, D as DefaultStatNumberFormat } from './chart-ui-utils.js';
import { e as ScatterPlotDataPopoverKinds, l as ScatterPlotSymbolSizeTypes, a as RESTSymbolType } from './interfaces.js';
...
const ArcgisChartsConfigScatterPlotData = /*@__PURE__*/ proxyCustomElement(class ArcgisChartsConfigScatterPlotData extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.arcgisChartsConfigScatterPlotPopoverChange = createEvent(this, "arcgisChartsConfigScatterPlotPopoverChange", 7);
        ...
        this.setShowTrendLine = (e) => {
            ...
            if (!showTrendLine && this.contentKind === ScatterPlotDataPopoverKinds.trendLine) {
        ...
        this.setTrendLineSymbol = (e) => {
            ...
            this.model.setLinearTrendSymbol(cloneDeep(lineSymbol));
        };
        /**
         * @category Event handler
         */
        this.symbolSizeChange = (e) => {
            ...
            if (value !== undefined && isCalciteInputValidNumber(value, referenceElement.min, referenceElement.max)) {
        ...
        this.changeSymbolSizeTypeToggle = () => {
            ...
            const appStateSizePolicyField = state.scatterPlotData[state.selectedChartId]?.sizePolicyField;
            /**
             ...
             */
            if (symbolSizeType === ScatterPlotSymbolSizeTypes.Proportional && appStateSizePolicyField !== undefined) {
                // set the size policy field to the one in the app state if `field` is defined in the stencil store
                this.model.setSizePolicy({
                    ...this.model.getSizePolicy(),
                    type: WebChartTypes.SizePolicy,
                    field: appStateSizePolicyField,
                });
            }
            else if (symbolSizeType === ScatterPlotSymbolSizeTypes.Fixed) {
        ...
        this.changeElementStyle = (e) => {
            ...
            if (target.value === "selectColor") {
                this.contentKind = ScatterPlotDataPopoverKinds.symbol;
                this.selectedElement = this.model.getFixedMarkerSymbol()?.color;
            }
            else if (target.value === "selectTrendLine") {
                this.contentKind = ScatterPlotDataPopoverKinds.trendLine;
        ...
        this.onXVariableSelectChange = () => {
            this.contentKind = ScatterPlotDataPopoverKinds.xAxisField;
        ...
        this.onYVariableSelectChange = () => {
            this.contentKind = ScatterPlotDataPopoverKinds.yAxisField;
        ...
        this.onSizeVariableSelectChange = () => {
            this.contentKind = ScatterPlotDataPopoverKinds.sizeVariable;
        ...
        this.setXYField = async (e) => {
            try {
                ...
                if (this.contentKind === ScatterPlotDataPopoverKinds.xAxisField) {
        ...
        this.setSizeVariableField = (e) => {
            try {
                ...
                state.scatterPlotData[state.selectedChartId] = {
                    ...state.scatterPlotData[state.selectedChartId],
        ...
        this.closeScatterPlotPopover = (e) => {
            if (this.scatterPlotPopover === e?.target) {
                this.contentKind = ScatterPlotDataPopoverKinds.none;
                this.removeScatterPlotPopover();
            }
        };
        /**
        ...
        this.onModelConfigChange = () => {
            ...
            if (this.minSizeInputElement !== undefined && minSize !== undefined) {
                ...
                if (isCalciteInputValidNumber(this.minSizeInputElement.value, this.minSizeInputElement.min, this.minSizeInputElement.max)) {
                    modifyCalciteInputStatus({
            ...
            if (this.maxSizeInputElement !== undefined && maxSize !== undefined) {
                ...
                if (isCalciteInputValidNumber(this.maxSizeInputElement.value, this.maxSizeInputElement.min, this.maxSizeInputElement.max)) {
                    modifyCalciteInputStatus({
    ...
    openPopover() {
        if (typeof this.selectedElement === "string" || !isEmpty(this.selectedElement)) {
    ...
    async componentWillLoad() {
        ...
        if (this.selectedSizeType === ScatterPlotSymbolSizeTypes.Proportional) {
            state.scatterPlotData[state.selectedChartId] = {
                ...state.scatterPlotData[state.selectedChartId],
     ...
     */
    renderXVariable() {
        return (h("arcgis-charts-config-field-select", { label: Tl(this.layerFieldsInfo, this.model.getXAxisField() ?? ""), ref: (e) => {
                this.xAxisElement = e;
     ...
     */
    renderYVariable() {
        return (h("arcgis-charts-config-field-select", { label: Tl(this.layerFieldsInfo, this.model.getYAxisField() ?? ""), ref: (e) => {
                this.yAxisElement = e;
     ...
     */
    renderStatistics() {
        const [r, g, b, a] = [...(this.model.getLinearTrendSymbol()?.color ?? no(0))];
        const stats = (h("div", { class: HTMLClasses.sectionContainer }, h("calcite-label", { class: HTMLClasses.label, layout: "inline-space-between" }, this.strings.showLinearTrend, h("calcite-switch", { class: HTMLClasses.switchElement, checked: this.model.getShowLinearTrend(), onCalciteSwitchChange: this.setShowTrendLine })), h("calcite-list", { label: "", selectionMode: "single", selectionAppearance: "border" }, h("calcite-list-item", { label: this.strings.trendLineStyle, value: "selectTrendLine", hidden: !this.model.getShowLinearTrend(), selected: this.selectedElement?.type === RESTSymbolType.SLS, ref: (e) => {
                this.selectTrendLineElement = e;
            }, onClick: this.changeElementStyle }, h("calcite-icon", { slot: "content-end", icon: "line-solid", style: { color: `rgba(${r},${g},${b},${a / 255})` }, class: HTMLClasses.iconSelect, onClick: this.changeElementStyle }))), h("div", { class: HTMLClasses.r2, hidden: !this.model.getShowLinearTrend() }, `${this.strings.r2}: ${Number.isNaN(this.r2) ? this.defaultR2Label : formatNumberToLocale(this.r2, DefaultStatNumberFormat)}`)));
        return stats;
    }
    /**
     * @category Render UX
     */
    renderFixedSymbol() {
        const fixedSymbol = (h("calcite-label", { class: HTMLClasses.label }, this.strings.size, h("calcite-input", { type: "number", name: "fixed-symbol-size", class: HTMLClasses.numberInput, min: 1, max: 100, step: 1, value: sanitizeNumber(this.model.getFixedMarkerSymbol()?.size), onCalciteInputInput: this.symbolSizeChange })));
        return fixedSymbol;
    }
    /**
     * @category Lifecycle
     ...
     */
    renderSizeVariable() {
        return (h("arcgis-charts-config-field-select", { label: Tl(this.layerFieldsInfo, this.model.getSizePolicy()?.field ?? ""), invalid: this.layerFieldsInfo.find((field) => field.name === this.model.getSizePolicy()?.field) === undefined, ref: (e) => {
     ...
     */
    renderMinSizeInput() {
        return (h("calcite-input", { type: "number", name: "proportional-symbol-min-size", class: HTMLClasses.numberInput, min: 1, max: this.model.getSizePolicy()?.maxSize ?? 100, step: 1, value: sanitizeNumber(this.model.getSizePolicy()?.minSize), onCalciteInputInput: this.symbolSizeChange, ref: (e) => {
     ...
     */
    renderMaxSizeInput() {
        return (h("calcite-input", { type: "number", name: "proportional-symbol-max-size", class: HTMLClasses.numberInput, min: this.model.getSizePolicy()?.minSize ?? 1, max: 100, step: 1, value: sanitizeNumber(this.model.getSizePolicy()?.maxSize), onCalciteInputInput: this.symbolSizeChange, ref: (e) => {
    ...
    renderProportionalSymbol() {
        const proportionalSymbol = (h("div", { class: HTMLClasses.sectionContainer }, h("calcite-label", { class: HTMLClasses.label }, this.strings.numberRequired, this.renderSizeVariable()), h("div", { class: HTMLClasses.multiInputSection }, h("calcite-label", { class: HTMLClasses.label }, this.strings.minSize, this.renderMinSizeInput()), h("calcite-label", { class: HTMLClasses.label }, this.strings.maxSize, this.renderMaxSizeInput())), h("calcite-label", null, h("calcite-slider", { min: 1, max: 100, minValue: toNumber(sanitizeNumber(this.model.getSizePolicy()?.minSize)), maxValue: toNumber(sanitizeNumber(this.model.getSizePolicy()?.maxSize)), step: 1, onCalciteSliderInput: this.symbolSizeRangeSliderInput }))));
    ...
    renderSymbolSizeType() {
        const symbolSizeTypeUI = (h("calcite-label", { class: HTMLClasses.label }, this.strings.size, h("calcite-segmented-control", { name: "symbolSizeType", layout: "horizontal", scale: "s", onCalciteSegmentedControlChange: this.changeSymbolSizeTypeToggle, ref: (e) => {
                this.symbolSizeModeElement = e;
            } }, h("calcite-segmented-control-item", { value: ScatterPlotSymbolSizeTypes.Fixed, checked: ScatterPlotSymbolSizeTypes.Fixed === this.selectedSizeType, ref: (el) => {
                el.focus = () => { };
                this.items.push(el);
            } }, this.strings.fixed), h("calcite-segmented-control-item", { value: ScatterPlotSymbolSizeTypes.Proportional, checked: ScatterPlotSymbolSizeTypes.Proportional === this.selectedSizeType, ref: (el) => {
                el.focus = () => { };
                this.items.push(el);
     ...
     */
    renderSymbol() {
        const [r, g, b, a] = [...(this.model.getFixedMarkerSymbol()?.color ?? no(0))];
        const symbol = (h("div", { class: HTMLClasses.sectionContainer }, this.renderSymbolSizeType(), this.selectedSizeType === ScatterPlotSymbolSizeTypes.Proportional
            ? this.renderProportionalSymbol()
            : this.renderFixedSymbol(), h("calcite-label", { class: HTMLClasses.label }, this.strings.color, this.isTableLayer !== true ? (h("calcite-segmented-control", { name: "layerColor", layout: "horizontal", scale: "s", onCalciteSegmentedControlChange: this.changeColorTypeToggle, ref: (e) => {
                this.colorModeElement = e;
            } }, h("calcite-segmented-control-item", { value: this.strings.useLayerColors, checked: this.model.getColorMatch(), ref: (el) => {
                el.focus = () => { };
                this.items.push(el);
            } }, this.strings.useLayerColors), h("calcite-segmented-control-item", { value: this.strings.singleColor, checked: !this.model.getColorMatch(), ref: (el) => {
                el.focus = () => { };
                this.items.push(el);
            } }, this.strings.singleColor))) : null), h("calcite-list", { label: "", selectionMode: "single", selectionAppearance: "border" }, h("calcite-list-item", { label: this.strings.color, value: "selectColor", hidden: this.model.getColorMatch() && this.isTableLayer !== true, selected: Array.isArray(this.selectedElement), ref: (e) => {
                this.selectColorElement = e;
            }, onClick: this.changeElementStyle }, h("calcite-icon", { slot: "content-end", icon: "circle-f", style: { color: `rgba(${r},${g},${b},${a / 255})` }, class: HTMLClasses.iconSelect, onClick: this.changeElementStyle })))));
        return symbol;
    }
    /**
     * @category Lifecycle
     */
    render() {
        return (h(Host, { key: '03f7f44733f9914b780dc1dc5f82f9a79438375e', class: { [HTMLClasses.rtl]: this.direction === "rtl" } }, h("h3", { key: 'dbfad812d143ff1f4d3cfd3ad1dadf9b31f26da4', class: HTMLClasses.sectionLabel }, this.strings.variables), h("calcite-label", { key: '59babdeb9d2a1c55416e0b5b9685e764446f7208', class: HTMLClasses.label }, this.strings.xAxisNumber, this.renderXVariable()), h("calcite-label", { key: '75fd11346598c9fee68f4b8c5049950845afc826', class: HTMLClasses.label }, this.strings.yAxisNumber, this.renderYVariable()), h("h3", { key: '6cbe9dba31d458f104e261814903bdb5f1824e66', class: HTMLClasses.sectionLabel }, this.strings.statistics), this.renderStatistics(), h("h3", { key: '4f60b0e15124a68050d18dd7588193ae7f9c5dda', class: HTMLClasses.sectionLabel }, this.strings.symbol), this.renderSymbol()));
    }
    /**
     * @category Private
     */
    setupScatterPlotPopover() {
        this.scatterPlotPopover = Jy(this.scatterPlotPopover);
        ...
        switch (this.contentKind) {
            case ScatterPlotDataPopoverKinds.xAxisField:
                ...
                break;
            case ScatterPlotDataPopoverKinds.yAxisField:
                ...
                this.scatterPlotPopover.headingTitle = this.strings.selectAField;
                break;
            case ScatterPlotDataPopoverKinds.sizeVariable:
                ...
                this.scatterPlotPopover.headingTitle = this.strings.selectAField;
                break;
            case ScatterPlotDataPopoverKinds.symbol:
            case ScatterPlotDataPopoverKinds.trendLine: {
                ...
                else if (element?.type === RESTSymbolType.SLS) {
        ...
        if (this.contentKind !== ScatterPlotDataPopoverKinds.none) {
    ...
    getCurrentSymbolSizeType() {
        ...
        return sizePolicy === undefined || sizePolicy.field === ""
            ? ScatterPlotSymbolSizeTypes.Fixed
            : ScatterPlotSymbolSizeTypes.Proportional;
    }
    ...
    static get style() { return ArcgisChartsConfigScatterPlotDataStyle0; }
}, [1, "arcgis-charts-config-scatter-plot-data", {
        "model": [16],
        "r2": [514, "r-2"],
        "layerFieldsInfo": [16],
        "isTableLayer": [4, "is-table-layer"],
        "open": [516],
        "selectedElement": [32],
        "selectedSizeType": [32],
        "updatesOccurred": [32]
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-config-scatter-plot-data", "arcgis-charts-config-field-select"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-config-scatter-plot-data":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcgisChartsConfigScatterPlotData);
            }
            break;
...
export { ArcgisChartsConfigScatterPlotData as A, defineCustomElement as d };
