...
import { a0 as wc, M as Mn, w as ta, J as ia, L as jl, A as Tl, Z as Zy, r as Qy, a2 as Jy } from './index2.js';
import { L as LineChartDataPopoverKinds, R as RESTStatisticType, b as RESTFieldType } from './interfaces.js';
...
import { d as WebChartTimeIntervalUnits, h as WebChartNullPolicyTypes } from './chart-object-literals.js';
...
const ArcGISChartsConfigLineChartData = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsConfigLineChartData extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.arcgisChartsConfigLineChartDataNumericFieldValidate = createEvent(this, "arcgisChartsConfigLineChartDataNumericFieldValidate", 7);
        this.arcgisChartsConfigDataChangeError = createEvent(this, "arcgisChartsConfigDataChangeError", 7);
        this.arcgisChartsConfigCustomizedTimeInterval = createEvent(this, "arcgisChartsConfigCustomizedTimeInterval", 7);
        this.arcgisChartsConfigResetTimeInterval = createEvent(this, "arcgisChartsConfigResetTimeInterval", 7);
        /**
         * @category Private
         */
        ...
        this.onAggregationSelect = () => {
            this.contentKind = LineChartDataPopoverKinds.aggregation;
            this.setupPopover();
        };
        /**
         * @category Event handler
        ...
        this.onXAxisFieldSelect = () => {
            this.contentKind = LineChartDataPopoverKinds.xAxisField;
            this.setupPopover();
        };
        /**
         * @category Event handler
        ...
        this.onSplitBySelect = () => {
            if (!this.splitByFieldElement.disabled) {
                this.contentKind = LineChartDataPopoverKinds.splitByField;
                this.setupPopover();
            }
        };
        /**
        ...
        this.onAddNumericFields = () => {
            this.contentKind = LineChartDataPopoverKinds.numericFields;
            this.setupPopover();
        };
        /**
         * @category Event handler
        ...
        this.onIntervalAlignmentSelect = () => {
            if (!this.intervalAlignmentElement.disabled) {
                this.contentKind = LineChartDataPopoverKinds.intervalAlignment;
                this.setupPopover();
            }
        };
        /**
        ...
        this.onIntervalSelect = () => {
            if (!this.intervalElement.disabled) {
                this.contentKind = LineChartDataPopoverKinds.interval;
                this.setupPopover();
            }
        };
        /**
    ...
    async componentWillRender() {
        ...
        if (timeAggregationType !== undefined) {
            this.timeAggregationLabel = await ia(timeAggregationType);
        }
    ...
    renderXAxisField() {
        ...
        return (h("arcgis-charts-config-field-select", { label: xAxisFieldString, ref: (e) => {
    ...
    renderInterval() {
        ...
        const timeIntervalUnitLabel = jl(this.model.getTimeIntervalUnits() ?? WebChartTimeIntervalUnits.Seconds, this.strings) ??
            "";
        return [
            h("calcite-list", { label: "", selectionAppearance: "border" }, h("calcite-list-item", { value: invalidTimeInterval ? "" : `${timeIntervalSize} ${timeIntervalUnitLabel}`, label: invalidTimeInterval ? "" : `${timeIntervalSize} ${timeIntervalUnitLabel}`, ref: (e) => {
                    this.intervalElement = e;
                }, onClick: invalidTimeInterval ? () => { } : this.onIntervalSelect }, h("calcite-icon", { slot: "content-end", icon: "pencil" }))),
            h("div", { class: HTMLClasses.linkContainer }, h("calcite-button", { appearance: "transparent", scale: "s", iconEnd: "reset", onClick: this.resetTimeIntervalOriginal }, this.strings.reset)),
        ];
    }
    /**
     * @category Render UX
    ...
    renderIntervalAlignment() {
        return (h("arcgis-charts-config-field-select", { label: this.timeAggregationLabel, disabled: false, ref: (e) => {
     ...
     */
    renderEmptyBins() {
        return (h("calcite-radio-button-group", { name: "empty-bins", layout: "vertical", onCalciteRadioButtonGroupChange: this.onNullPolicyChange }, h("calcite-label", { layout: "inline" }, h("calcite-radio-button", { value: WebChartNullPolicyTypes.Zero, checked: this.model.getNullPolicy() === WebChartNullPolicyTypes.Zero }), this.strings.treatAsZero), h("calcite-label", { layout: "inline" }, h("calcite-radio-button", { value: WebChartNullPolicyTypes.Interpolate, checked: this.model.getNullPolicy() === WebChartNullPolicyTypes.Interpolate }), this.strings.connectLine), h("calcite-label", { layout: "inline" }, h("calcite-radio-button", { value: WebChartNullPolicyTypes.Null, checked: this.model.getNullPolicy() === WebChartNullPolicyTypes.Null }), this.strings.breakLine)));
    }
    /**
     * @category Render UX
     * @param field
    ...
    render() {
        ...
        return (h(Host, { key: 'b6451eb6ec2b1d61dabc871233690263e1e794d9', class: { [HTMLClasses.rtl]: this.direction === "rtl" } }, h("calcite-label", { key: '06c94128f7c237740b6d13aecc4f3f558f4b5467', class: HTMLClasses.label }, this.strings.xAxisField, xAxisFieldUI), h("calcite-label", { key: '5f811e5ccc7b591b235eb0e9f29c263d136faca3', class: HTMLClasses.label }, this.strings.aggregation, aggregationUI), h("calcite-label", { key: '32789b718f017c6a838269ee6fc6aed3dee48ed4', class: HTMLClasses.label }, this.strings.numericFields, numericFieldsUI), h("div", { key: 'b4d894b98efbebf17b59c3369aa9276541d9d246', class: HTMLClasses.fab }, h("calcite-fab", { key: 'f430a7551f1939969dc87e9ca4362847703c8884', appearance: "outline-fill", kind: "neutral", scale: "m", label: this.strings.selectNumericFields, "text-enabled": true, text: this.strings.selectNumericFields, icon: "plus", onClick: this.onAddNumericFields })), h("calcite-label", { key: '55fd93a584f2c08e835f2dd892e69c3206996174', class: HTMLClasses.label }, h("span", { key: '81f68686c3a64f9747f5f5bf08afecd1496cf2e0', class: this.disableSplitBy ? HTMLClasses.dimText : "" }, this.strings.splitBy), splitByUI), h("div", { key: 'b249e03ec9f0ac5692730e15cf2df636ddc73e0e', hidden: !this.shouldShowTimeBinning() }, h("h3", { key: 'af2c5bca4a508f8ef25b47f8b302bbd511c1e916', class: HTMLClasses.timeBinningHeader }, this.strings.timeBinningOptions), h("calcite-label", { key: 'dd23237541552296bfd92831efaca1a4b2b5dac3', class: HTMLClasses.label }, this.strings.interval, intervalUI), h("calcite-label", { key: '022b35e04bf70f525630e6ae160181882790c317', class: HTMLClasses.label }, this.strings.intervalAlignment, intervalAlignmentUI), h("calcite-label", { key: '4cc20bb8cdb6f7d780188a10b3af8a5929d841c8', class: HTMLClasses.label, layout: "inline-space-between" }, this.strings.trimIncompleteInterval, h("calcite-switch", { key: 'fffe1ad70264153507220b9a7125e5c9c2dd1235', checked: this.model.getTrimIncompleteTimeInterval(), onCalciteSwitchChange: this.onTrimIncompleteIntervalChange })), h("calcite-label", { key: 'e0e359e36873a557d6b9ed2e6c990fb5bc2b656b', class: HTMLClasses.label }, this.strings.emptyBins, emptyBinsUI)), h("calcite-label", { key: 'be1c2ad0ed5fe37e8a4206df7a51e6f5f4c2e040', class: HTMLClasses.label, layout: "inline-space-between" }, this.strings.showDataLabels, h("calcite-switch", { key: 'ce968955a4afcf74795da6cfa5b345a37bf4858e', checked: this.model.getDataLabelsVisibility(), onCalciteSwitchChange: this.onShowDataLabelsChange }))));
    }
    /**
    ...
    shouldShowTimeBinning() {
        ...
        const isDateField = xAxisFieldObject?.type === RESTFieldType.Date;
        const isUsingAggregation = this.model.getAggregationType() !== RESTStatisticType.NoAggregation;
    ...
    setupPopover() {
        ...
        this.lineChartPopover = Zy(Qy.LineChartDataPopover, popoverConfig);
        if (this.lineChartPopover !== null) {
            const timeIntervalProps = {
                timeIntervalSize: this.model.getTimeIntervalSize() ?? 1,
                timeIntervalUnits: this.model.getTimeIntervalUnits() ?? WebChartTimeIntervalUnits.Seconds,
            };
    ...
    removeLineChartDataPopover() {
        if (this.lineChartPopover !== null) {
            ...
            this.lineChartPopover = Jy(this.lineChartPopover);
        }
    }
    ...
    static get style() { return ArcgisChartsConfigLineChartDataStyle0; }
}, [1, "arcgis-charts-config-line-chart-data", {
        "model": [16],
        "resetTimeInterval": [16],
        "layerFieldsInfo": [16],
        "open": [516],
        "updatesOccurred": [32]
    }, undefined, {
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-config-line-chart-data", "arcgis-charts-config-field-select"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-config-line-chart-data":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsConfigLineChartData);
            }
            break;
...
export { ArcGISChartsConfigLineChartData as A, defineCustomElement as d };
