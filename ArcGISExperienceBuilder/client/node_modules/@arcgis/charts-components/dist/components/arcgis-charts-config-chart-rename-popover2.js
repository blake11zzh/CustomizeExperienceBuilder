...
const ArcgisChartsConfigChartRenamePopover = /*@__PURE__*/ proxyCustomElement(class ArcgisChartsConfigChartRenamePopover extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.arcgisChartsConfigChartRenamePopoverChange = createEvent(this, "arcgisChartsConfigChartRenamePopoverChange", 7);
     ...
     */
    render() {
        return (h(Host, { key: 'a1631e64413969232b3ba9cddd11ee92053f35ea', class: `${HTMLClasses.chartRenameComponent} ${HTMLClasses.jsAppFlyout}` }, h("calcite-popover", { key: 'ee214851896443abcd5637db875c8c09c77b4e52', referenceElement: this.popoverReferenceElement, ref: (e) => {
                this.popoverElement = e;
            }, onCalcitePopoverClose: this.popoverClose, open: this.open, placement: "bottom", label: "" }, h("calcite-panel", { key: '6f6ca5f439e7a60ba8ad76b609a3d61bb0ff3916', class: HTMLClasses.renamePanel, closable: true, closed: !this.open, onCalcitePanelClose: this.popoverClose, heading: this.strings.renameChart }, h("div", { key: '05db16ee88391d6414ae20dfaffdf43588e86db5', class: HTMLClasses.renameLabelContainer }, h("calcite-label", { key: '2bf02bdfd4800a7d3bf61d820d185000495069e2' }, this.strings.chartName, h("calcite-input", { key: '50ed46890fda0be6bff788ab4e129d5470539fd5', required: true, type: "text", value: this.changedName, onCalciteInputInput: this.onNameChange, ref: (e) => {
                this.characterLimitInputElement = e;
            } }), h("arcgis-charts-config-invalid-input-message", { key: 'a8d6c829d0f27af1d75edecc3a569cb9b3ef5d3a', invalidInputMessage: this.strings.emptyChartTitle, isInvalid: this.isChartTitleInvalid }))), h("calcite-button", { key: 'e0410269488356ce566648501dd22a86096348f7', slot: "footer", appearance: "solid", scale: "m", width: "half", onClick: this.onSubmitClick }, this.strings.submit), h("calcite-button", { key: '9e2d33804654253574b7bad25cf1c8674176f2fc', slot: "footer", appearance: "outline-fill", scale: "m", width: "half", onClick: this.onCancelClick }, this.strings.cancel)))));
    }
    ...
    static get style() { return ArcgisChartsConfigChartRenamePopoverStyle0; }
}, [1, "arcgis-charts-config-chart-rename-popover", {
        "name": [513],
        "open": [1028],
        "popoverReferenceElement": [16],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-config-chart-rename-popover", "arcgis-charts-config-invalid-input-message"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-config-chart-rename-popover":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcgisChartsConfigChartRenamePopover);
            }
            break;
...
export { ArcgisChartsConfigChartRenamePopover as A, defineCustomElement as d };
