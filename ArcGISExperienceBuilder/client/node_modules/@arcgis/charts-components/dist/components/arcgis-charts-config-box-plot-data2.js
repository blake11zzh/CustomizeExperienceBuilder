...
import { a2 as Jy, a3 as eo, M as Mn, a1 as Cl, A as Tl, Z as Zy, r as Qy } from './index2.js';
import { c as BoxPlotDataPopoverKinds, f as ButtonDirections } from './interfaces.js';
...
const ArcGISChartsConfigBoxPlotData = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsConfigBoxPlotData extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h(Host, { key: 'cc75b64ad20cb075936afa26f80935ad5cdfe906', class: { [HTMLClasses.rtl]: this.direction === "rtl" } }, h("calcite-label", { key: '0dbf49c20d1777e0450ea64baff966cfdf51008d', class: HTMLClasses.label }, this.strings.numericFields, numericFieldsUI), h("div", { key: '3071277d5b95dee21a3e40d45bfb6c81afa6e0ae', class: HTMLClasses.fab }, h("calcite-fab", { key: '135d17641f4dd93b1f09b27de71885f93e26698a', appearance: "outline-fill", kind: "neutral", scale: "m", label: this.strings.selectNumericFields, "text-enabled": true, text: this.strings.selectNumericFields, icon: "plus", onClick: this.onAddNumericFields })), h("calcite-label", { key: '7baa4b742ffc4b357e208a87151d2d3e3e0f09a3', class: HTMLClasses.label }, h("div", { key: 'c7025c74ff2ac688fa57902a44dfcc966e40edb9' }, this.strings.category, " ", h("span", { key: '5c03d992841481729fb2396a751de07ac3bb4c8e', class: HTMLClasses.dimText }, "(", this.strings.optional, ")")), categoryUI), h("calcite-label", { key: '68ae7c61ce920aafa3e13c45c08bfd6dbda5b064', class: HTMLClasses.label }, h("div", { key: '7482d8325464608aa062e55293972bfd3e44b1cc', class: this.disableSplitBy ? HTMLClasses.dimText : "" }, this.strings.splitBy, " ", h("span", { key: 'b3cd9c2ccc08fc424cc939a5e0bab2fc5e689169', class: HTMLClasses.dimText }, "(", this.strings.optional, ")")), splitByUI), h("div", { key: '5f98ab70bb32bd3e81cd016eeb5a081c38ccc39d' }, this.model.getNumericFields().length > 1 ? (h("calcite-label", { class: HTMLClasses.label, layout: "inline-space-between" }, this.strings.standardizeValues, h("calcite-switch", { checked: this.model.getStandardizeValues(), onCalciteSwitchChange: this.onStandardizeValuesChange }))) : null), h("calcite-label", { key: '43e30d282adeae27b50a3a16d60454c26e582fbe', class: HTMLClasses.label, layout: "inline-space-between" }, this.strings.showOutliers, h("calcite-switch", { key: 'ece331d79f8ecfe2525dca40cfbe878584e97b50', checked: this.model.getShowOutliers(), onCalciteSwitchChange: this.onShowOutliersChange })), h("calcite-label", { key: '262ba118dd084bdf8b91d9927ec7d5ddb85de3da', class: HTMLClasses.label }, this.strings.sortOrder, sortingUI), customSortUI));
    }
    /**
     * @category Private
     */
    ...
    static get style() { return ArcgisChartsConfigBoxPlotDataStyle0; }
}, [1, "arcgis-charts-config-box-plot-data", {
        "model": [16],
        "layerFieldsInfo": [16],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-config-box-plot-data", "arcgis-charts-config-field-select"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-config-box-plot-data":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsConfigBoxPlotData);
            }
            break;
...
export { ArcGISChartsConfigBoxPlotData as A, defineCustomElement as d };
