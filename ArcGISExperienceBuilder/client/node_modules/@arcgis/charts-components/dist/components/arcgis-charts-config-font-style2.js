...
import { M as Mn, ah as lo } from './index2.js';
...
import { a as RESTSymbolType, i as RESTFontWeight, h as RESTFontStyle, g as RESTFontDecoration } from './interfaces.js';
...
const ArcgisChartsConfigFontStyle = /*@__PURE__*/ proxyCustomElement(class ArcgisChartsConfigFontStyle extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.arcgisChartsConfigFontStyleChange = createEvent(this, "arcgisChartsConfigFontStyleChange", 7);
        this.arcgisChartsConfigFontStyleClose = createEvent(this, "arcgisChartsConfigFontStyleClose", 7);
        /**
        ...
        this.fontSizeChange = () => {
            ...
            if (value !== undefined &&
                isCalciteInputValidNumber(value, this.fontSizeInputElement.min, this.fontSizeInputElement.max)) {
                const font = {
         ...
         */
        this.boldSelect = () => {
            let weight = RESTFontWeight.Bold;
         ...
         */
        this.italicSelect = () => {
            let style = RESTFontStyle.Italic;
        ...
        this.underlineSelect = () => {
            let decoration = RESTFontDecoration.Underline;
     ...
     */
    renderFonts() {
        const options = Object.values(fonts).map((fontFamily) => (h("calcite-option", { value: fontFamily, selected: fontFamily === this.fontStyle?.font?.family ||
                (fontFamily === lo().font?.family?.split(",")[0] &&
                    this.fontStyle?.font?.family === undefined) }, fontFamily)));
        if (this.fontStyle?.font?.family === "") {
            options.push(h("calcite-option", { value: "", selected: true }));
        }
        return options;
    }
    /**
     ...
     */
    render() {
        return (h(Host, { key: '75b86eba607feb5c2b8964ebadc61b95b8d57330' }, h("calcite-panel", { key: 'caf344345708f84117d3f021f1e01fd12969b0a0', heading: this.header ?? this.strings.header, closed: this.open === false, closable: this.enableClose ?? false, onCalcitePanelClose: this.closePanel }, h("div", { key: '8d93dfd3eef37c65157dced9d95253dfc1ae2c27', class: HTMLClasses.fontStyleContainer }, h("calcite-label", { key: '419ff08e220b2bf866c1301d8e02433549a458b2', class: HTMLClasses.font }, this.strings.font, h("calcite-select", { key: '646c3a32f6da72f32be86d34ffd53994195d8037', label: this.strings.font, onCalciteSelectChange: this.fontChange }, this.renderFonts()))), h("div", { key: 'b1e6ac791d0ec40907a0c9e225ce77211c1487c4', class: HTMLClasses.fontStyleContainer }, h("calcite-label", { key: 'c04c5854230473b95c2e7b580f28731c007bad36', class: HTMLClasses.inputLabel }, this.strings.size, h("calcite-input", { key: 'fe399e75b8911b3deb2b9ca5cff73e48d154f43e', class: HTMLClasses.numberInput, type: "number", min: 6, max: 40, step: 1, value: sanitizeNumber(this.fontStyle?.font?.size), onCalciteInputInput: this.fontSizeChange, ref: (e) => {
                this.fontSizeInputElement = e;
            } })), h("calcite-action", { key: 'e22c777f3dc9e497deeb64b681c1bb35b5734aed', appearance: "transparent", text: this.strings.bold, onClick: this.boldSelect, scale: "l", active: this.fontStyle?.font?.weight === RESTFontWeight.Bold }, h("calcite-icon", { key: 'c30885871f977d0ebcee9c3ca64c38cebbf61783', scale: "s", icon: "bold" })), h("calcite-action", { key: '50807f25ab321141d217d48bd97500f911648acc', appearance: "transparent", text: this.strings.italic, onClick: this.italicSelect, scale: "l", active: this.fontStyle?.font?.style === RESTFontStyle.Italic }, h("calcite-icon", { key: '237ad61bb8a0a55d1315d8ecf305179f9072a55d', scale: "s", icon: "italicize" })), h("calcite-action", { key: '6e02aaa147466da441d5087b3b720b5ee3fd3cea', appearance: "transparent", text: this.strings.underline, onClick: this.underlineSelect, scale: "l", active: this.fontStyle?.font?.decoration === RESTFontDecoration.Underline }, h("calcite-icon", { key: 'd9a77e6d19a113dbe6db8bb2ebda3d174bb3a6af', scale: "s", icon: "underline" }))), h("div", { key: '90a97c69e7098bda8a8648656eff715da3244418', class: HTMLClasses.fontStyleContainer }, h("arcgis-charts-config-colors", { key: 'ae70a57b7970b2b61dd7d5e9496cf28a6ea2d6c5', rgba: this.fontStyle?.color ?? undefined, onColorSelect: this.colorChange })))));
    }
    /**
     * @param payload
     * @category Private
    ...
    static get style() { return ArcgisChartsConfigFontStyleStyle0; }
}, [1, "arcgis-charts-config-font-style", {
        "fontStyle": [1040],
        "header": [1],
        "open": [1540],
        "enableClose": [516, "enable-close"]
    }]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["arcgis-charts-config-font-style", "arcgis-charts-config-colors"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-config-font-style":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcgisChartsConfigFontStyle);
            }
            break;
...
export { ArcgisChartsConfigFontStyle as A, defineCustomElement as d };
