...
const ArcgisChartsConfigBarChartSeriesPopover = /*@__PURE__*/ proxyCustomElement(class ArcgisChartsConfigBarChartSeriesPopover extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ArcgisChartsConfigBarChartSeriesPopoverStyle0; }
}, [1, "arcgis-charts-config-bar-chart-series-popover", {
        "referenceElement": [16],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-config-bar-chart-series-popover", "arcgis-charts-config-colors"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-config-bar-chart-series-popover":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcgisChartsConfigBarChartSeriesPopover);
            }
            break;
...
export { ArcgisChartsConfigBarChartSeriesPopover as A, defineCustomElement as d };
