...
import { I as Ig, D as Dg, M as Mg, $ as $g, q as qg } from './index3.js';
import { x as xl, n as fs, Z as Zy, k as Yc, f as fl, p as iu, M as Mn, W as Wy, O as On, r as Qy } from './index2.js';
...
import { s as supportedChartTypes } from './interfaces2.js';
import { d as defineCustomElement$q, A as AxisModelWrapper } from './arcgis-charts-config-axis2.js';
import { d as defineCustomElement$r } from './arcgis-charts-config-axes2.js';
import { d as defineCustomElement$p } from './arcgis-charts-config-bar-chart2.js';
import { d as defineCustomElement$o } from './arcgis-charts-config-bar-chart-data2.js';
import { d as defineCustomElement$n } from './arcgis-charts-config-bar-chart-series2.js';
import { d as defineCustomElement$m } from './arcgis-charts-config-box-plot2.js';
import { d as defineCustomElement$l } from './arcgis-charts-config-box-plot-data2.js';
import { d as defineCustomElement$k } from './arcgis-chars-config-box-plot-series.js';
import { d as defineCustomElement$j } from './arcgis-charts-config-category-format2.js';
import { d as defineCustomElement$i } from './arcgis-charts-config-field-select2.js';
import { d as defineCustomElement$h } from './arcgis-charts-config-format2.js';
import { d as defineCustomElement$g } from './arcgis-charts-config-general2.js';
import { d as defineCustomElement$f } from './arcgis-charts-config-guide2.js';
import { d as defineCustomElement$e } from './arcgis-charts-config-guides2.js';
import { d as defineCustomElement$d } from './arcgis-charts-config-histogram2.js';
import { d as defineCustomElement$c } from './arcgis-charts-config-histogram-data2.js';
import { d as defineCustomElement$b } from './arcgis-charts-config-invalid-input-message2.js';
import { d as defineCustomElement$a } from './arcgis-charts-config-line-chart2.js';
import { d as defineCustomElement$9 } from './arcgis-charts-config-line-chart-data2.js';
import { d as defineCustomElement$8 } from './arcgis-charts-config-line-chart-series2.js';
import { d as defineCustomElement$7 } from './arcgis-charts-config-number-format2.js';
import { d as defineCustomElement$6 } from './arcgis-charts-config-pie-chart2.js';
import { d as defineCustomElement$5 } from './arcgis-charts-config-pie-chart-data2.js';
import { d as defineCustomElement$4 } from './arcgis-charts-config-pie-chart-slices2.js';
import { d as defineCustomElement$3 } from './arcgis-charts-config-scatter-plot2.js';
import { d as defineCustomElement$2 } from './arcgis-charts-config-scatter-plot-data2.js';
import { d as defineCustomElement$1 } from './arcgis-charts-config-view-charts2.js';
...
const ArcGISChartsConfigCreateFlow = /*@__PURE__*/ proxyCustomElement(class ArcGISChartsConfigCreateFlow extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ArcgisChartsConfigCreateFlowStyle0; }
}, [1, "arcgis-charts-config-create-flow", {
        "modelList": [1040],
        "layerList": [16],
        "selectedChartId": [1537, "selected-chart-id"],
        "activeLayerId": [513, "active-layer-id"],
        "disableEditing": [516, "disable-editing"],
        "syncChartsToLayers": [516, "sync-charts-to-layers"],
        "timeZone": [513, "time-zone"],
        "headerTitle": [513, "header-title"],
        "open": [1540],
        "chartData": [16],
        "r2": [2, "r-2"],
        "calculatedDataMinMaxBounds": [1040],
        "calculatedMinMaxBounds": [1040],
        "seriesColor": [1040],
        "popoverPlacement": [513, "popover-placement"],
        "usePopupTemplateFieldsInfo": [4, "use-popup-template-fields-info"],
        "panelNumber": [1538, "panel-number"],
        "modelLoading": [516, "model-loading"],
        "filterBySelection": [4, "filter-by-selection"],
        "selectedPanel": [32],
        "currentChartTypeText": [32],
        "updatesOccurred": [32],
        "setFocus": [64]
    }, undefined, {
        "layerList": ["layerListChange"],
...
function defineCustomElement() {
    ...
    const components = ["arcgis-charts-config-create-flow", "arcgis-charts-config-axes", "arcgis-charts-config-axis", "arcgis-charts-config-bar-chart", "arcgis-charts-config-bar-chart-data", "arcgis-charts-config-bar-chart-series", "arcgis-charts-config-box-plot", "arcgis-charts-config-box-plot-data", "arcgis-charts-config-box-plot-series", "arcgis-charts-config-category-format", "arcgis-charts-config-field-select", "arcgis-charts-config-format", "arcgis-charts-config-general", "arcgis-charts-config-guide", "arcgis-charts-config-guides", "arcgis-charts-config-histogram", "arcgis-charts-config-histogram-data", "arcgis-charts-config-invalid-input-message", "arcgis-charts-config-line-chart", "arcgis-charts-config-line-chart-data", "arcgis-charts-config-line-chart-series", "arcgis-charts-config-number-format", "arcgis-charts-config-pie-chart", "arcgis-charts-config-pie-chart-data", "arcgis-charts-config-pie-chart-slices", "arcgis-charts-config-scatter-plot", "arcgis-charts-config-scatter-plot-data", "arcgis-charts-config-view-charts"];
    components.forEach(tagName => { switch (tagName) {
        case "arcgis-charts-config-create-flow":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ArcGISChartsConfigCreateFlow);
            }
            break;
...
export { ArcGISChartsConfigCreateFlow as A, defineCustomElement as d };
