...
import { ActionModes, ActionToggle, DefaultChartActions, ActionState } from "@arcgis/charts-shared-utils";
import type { DefaultActionSelectPayload } from "../../utils/event-payloads";
/**
...
export declare class ArcGISChartsActionBar {
    ...
    /**
     * Localized string
     * @type {typeof import("./t9n/messages.en.json")}
     * @category Private
     */
    private strings;
    /**
