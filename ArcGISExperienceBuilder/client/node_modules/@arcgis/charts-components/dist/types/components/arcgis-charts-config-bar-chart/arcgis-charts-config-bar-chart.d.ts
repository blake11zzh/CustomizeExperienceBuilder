...
/** @internal */
export declare class ArcGISChartsConfigBarChart {
    /**
     * @category Public
     */
    hostElement: HTMLArcgisChartsConfigBarChartElement;
    /**
     * Bar Chart Model.
     * @category Public
     */
     ...
     * @category Private
     */
    private activeColorMatch;
    /**
     * Event indicating no series update should take place.
     * @event
     */
    arcgisChartsNoSeriesUpdate: EventEmitter;
    /**
     * @category Private
     */
