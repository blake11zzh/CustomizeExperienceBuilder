...
import type { IntervalPopoverProps } from "../../interfaces";
import { LineChartDataPopoverKinds } from "../../interfaces";
/** @internal */
export declare class ArcgisChartsConfigLineChartPopover {
    /**
     * @category Public
     */
    hostElement: HTMLArcgisChartsConfigLineChartPopoverElement;
    /**
     * @category Private
     */
    private strings;
     ...
     * @event
     */
    arcgisChartsConfigLineChartDataPopoverChange: EventEmitter;
    /**
     * Event emitted when the popover is closed.
     * @event
     */
    arcgisChartsConfigLineChartPopoverClose: EventEmitter;
    /**
     ...
     * @category Private
     */
    private intervalSizeElement;
    /**
     * @category Private
     */
    private intervalTypeElement;
    /**
     * @category Private
     */
     ...
     * @category Render UX
     */
    private buildIntervalAlignmentPickListItems;
    /**
     * @param field
     * @category Render UX
     */
